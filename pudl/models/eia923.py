...
class CoalMineEIA923(pudl.models.entities.PUDLBase):
    ...
    id = Column(Integer, primary_key=True, comment="PUDL issued surrogate key.")  # surrogate key
    ...
    county_id_fips = Column(Integer, comment="County ID from the Federal Information Processing Standard Publication 6-4.")
