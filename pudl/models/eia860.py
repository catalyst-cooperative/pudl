...
class UtilityEIA860(pudl.models.entities.PUDLBase):
    ...
    street_address = Column(String, comment="Street address of the operator/owner")
    city = Column(String, comment="Name of the city in which operator/owner is located")
