...
stocks_map_eia923_old = pd.DataFrame.from_records([
...
boiler_fuel_map_eia923_old = pd.DataFrame.from_records([
...
generator_map_eia923_old = pd.DataFrame.from_records([
...
fuel_receipts_costs_map_eia923_old = pd.DataFrame.from_records([
...
plant_frame_map_eia923_old = pd.DataFrame.from_records([
