...
<https://docs.dagster.io/concepts/ops-jobs-graphs/dynamic-graphs>`__ of ops wrapped by a`graph backed <https://docs.dagster.io/concepts/assets/graph-backed-assets>`__ asset.
