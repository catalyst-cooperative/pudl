...
###########################################################################
def connect_db(pudl_settings=None):
    """
    Create an SQL Alchemy engine to connect to the FERC Form 1 SQLite DB.

    The SQLite DB file will be located at: ``PUDL_OUT/sqlite/ferc1.sqlite``
    ...
    Returns:
        :class:`sqlalchemy.engine.Engine`: An SQL Alchemy database engine
        allowing access to the FERC Form 1 SQLite database.
...
def _create_tables(engine, md):
    """Creates the FERC Form 1 DB tables in the SQLite database.
