...
raw_rus12__all_dfs = raw_df_factory(Extractor, name="rus12", op_tags=COLD_PATH_OP_TAGS)


def raw_rus12_asset_factory(table_name: str):
    """Create raw RUS 12 asset for a specific page."""

    @asset(name=f"raw_rus12__{table_name}", op_tags=COLD_PATH_OP_TAGS)
