...
def create_raw_ferc714_xbrl_assets() -> list[AssetSpec]:
    """Create AssetSpec for raw FERC 714 XBRL tables.

    AssetSpec allows you to access assets that are generated elsewhere.
    ...
    raw_ferc714_xbrl_assets = [
        AssetSpec(
            ...
            metadata={"dagster/io_manager_key": "ferc714_xbrl_sqlite_io_manager"},
        )
