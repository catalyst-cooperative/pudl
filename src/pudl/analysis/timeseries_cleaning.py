...
class UTCTimeseriesDataFrame(pa.DataFrameModel):
    ...
    converted to a ``LocalizedTimeseriesDataFrame``, then pivoted
...
class TimeseriesMatrix(pa.DataFrameModel):
    ...
    generated by pivoting a ``LocalizedTimeseriesDataFrame``, this
...
def pivot_localized_timeseries_dataframe(
    localized_df: DataFrame[LocalizedTimeseriesDataFrame],
