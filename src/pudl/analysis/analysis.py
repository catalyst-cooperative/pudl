...
def frc_by_pudl(pudl_plant_ids, pudl_engine,
    ...
    """
    tables = pudl.output.pudltabl.get_table_meta(pudl_engine)
    # Get all the EIA info from generation_fuel_eia923
    frc_df = pudl.output.eia923.fuel_receipts_costs_eia923(
        pudl_engine, tables)
...
def gen_fuel_by_pudl(pudl_plant_ids, pudl_engine,
    ...
    tables = pudl.output.pudltabl.get_table_meta(pudl_engine)
    # Get all the EIA info from generation_fuel_eia923
    gf_df = pudl.output.eia923.generation_fuel_eia923(pudl_engine, tables)
