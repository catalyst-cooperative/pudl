...
entities = {
    'plants': [  # base cols
        ...
        ['balancing_authority_code', 'balancing_authority_name',
         ...
         'iso_rto_code', 'iso_rto', 'latitude', 'longitude',
...
column_dtypes = {
    ...
    "eia": {
        ...
        'energy_source_code_2': str,
        'energy_source_code_3': str,
        'energy_source_code_4': str,
        ...
        'ferc_small_power_producer': bool,
        ...
        'natural_gas_delivery_contract_type_code': str,
        'natural_gas_local_distribution_company': str,
        'natural_gas_pipeline_name_1': str,
        'natural_gas_pipeline_name_2': str,
        'natural_gas_pipeline_name_3': str,
        'natural_gas_storage': bool,
        'natural_gas_transport_code': str,
        'nerc_region': str,
        ...
        'operational_status': str,  # TODO: double check this for early 860 years
        'operational_status_code': str,
        'other_combustion_tech': bool,
        'other_modifications_date': 'datetime64[ns]',
        'other_planned_modifications': bool,
        'owner_city': str,
        'owner_name': str,
        'owner_state': str,
        ...
        'planned_energy_source_code_1': str,
        'planned_modifications': bool,
        ...
        'planned_new_prime_mover_code': str,
        ...
        'plants_reported_other_relationship': bool,
        'plants_reported_owner': str,
        'pulverized_coal_tech': bool,
        'previously_canceled': bool,
        'primary_transportation_mode_code': str,
        'primary_purpose_naics_id': pd.Int64Dtype(),
        'prime_mover_code': str,
        'regulatory_status_code': str,
        'report_date': 'datetime64[ns]',
        'rto_iso_lmp_node_id': str,
        ...
        'startup_source_code_3': str,
        'startup_source_code_4': str,
        'state': str,
        'street_address': str,
        'stoker_tech': bool,
        'subcritical_tech': bool,
