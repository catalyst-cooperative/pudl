...
def boiler_cooling(eia860_dfs, eia860_transformed_dfs):
    """Pull and transform the boiler cooling system association table.
    ...
    * Drop duplicate rows.
    ...
    Returns:
        ...
        page (values).
    """
    # Populating the 'boiler_cooling_eia860' table
    b_c_df = eia860_dfs["boiler_cooling"].copy()

    b_c_df = pudl.helpers.convert_to_date(b_c_df)
    b_c_df = pudl.helpers.convert_cols_dtypes(df=b_c_df, data_source="eia")
    b_c_df = b_c_df.drop_duplicates()

    b_c_df = (
        pudl.metadata.classes.Package.from_resource_ids()
        .get_resource("boiler_cooling_eia860")
        .encode(b_c_df)
    )

    eia860_transformed_dfs["boiler_cooling_eia860"] = b_c_df
...
def boiler_nox(eia860_dfs, eia860_transformed_dfs):
    """Pull and transform the boiler mercury control system association table.
    ...
    * Drop duplicate rows.
    ...
    """
    # Populating the 'boiler_cooling_eia860' table
    b_m_df = eia860_dfs["boiler_nox"].copy()

    b_m_df = pudl.helpers.convert_to_date(b_m_df)
    b_m_df = pudl.helpers.convert_cols_dtypes(df=b_m_df, data_source="eia")
    b_m_df = b_m_df.drop_duplicates()

    b_m_df = (
        pudl.metadata.classes.Package.from_resource_ids()
        .get_resource("boiler_nox_eia860")
        .encode(b_m_df)
    )

    eia860_transformed_dfs["boiler_nox_eia860"] = b_m_df

    return eia860_transformed_dfs


def boiler_mercury(eia860_dfs, eia860_transformed_dfs):
    """Pull and transform the boiler mercury control system association table.
    ...
    * Drop duplicate rows.
    ...
    """
    # Populating the 'boiler_cooling_eia860' table
    b_m_df = eia860_dfs["boiler_mercury"].copy()
    ...
    b_m_df = (
        pudl.metadata.classes.Package.from_resource_ids()
        .get_resource("boiler_mercury_eia860")
        .encode(b_m_df)
    )

    eia860_transformed_dfs["boiler_mercury_eia860"] = b_m_df
...
def transform(eia860_raw_dfs, eia860_settings: Eia860Settings = Eia860Settings()):
    ...
    eia860_transform_functions = {
        ...
        "boiler_cooling_eia860": boiler_cooling,
        "boiler_mercury_eia860": boiler_mercury,
        "boiler_nox_eia860": boiler_nox,
    }
