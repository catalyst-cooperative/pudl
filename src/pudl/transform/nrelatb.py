...
def broadcast_asterisk_cost_recovery_period_years(
    ...
    :func:`_core_nrelatb__transform_start`). This is a part of the tables primary key
    ...
    :func:`_broadcast_core_metric_parameters`) so they end up with nulls in the
    ...
    """
    mask_broadcast = nrelatb_unstacked.cost_recovery_period_years.isna()
    idx_broadcast = [
