...
class Exploder:
    ...
    def add_sizable_minority_corrections(
        ...
        :attr:`self.off_by_facts`. This method identifies data corrections for those
        :attr:`self.off_by_facts` and adds them into the exploded data table.
        ...
        subcomponents (via
        :func:`pudl.transform.ferc1.calculate_values_from_components`) and finding the
        ...
        # Identify the calculations with one missing other fact: when the diff is
        # (approximately) the same as the value of another fact, then that calculated
        # value could have been perfect with the addition of the missing factoid.
