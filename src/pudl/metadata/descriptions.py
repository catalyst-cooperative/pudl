...
Such resources should not provide description.additional_summary_text, and the system will apply only the first fragment here.
If a resource provides description.additional_summary_text, the system will apply both fragments from the corresponding table_type_fragments entry, so that the summary starts with standardized text but finishes with more specific information.
...
* Rendered summary: "Association table"
  ...
  * metadata description.additional_summary_text: not specified

* Rendered summary: "Association table providing connections between cats and Catalysters."

  * resource name: [layer]_[source]__assn_[slug]
  * metadata description.additional_summary_text: "cats and Catalysters."
"""
...
class ResourceDescriptionBuilder:
    ...
    * ResourceNameComponents, which automatically extracts appropriate description codes from the resource id
    ...
    * usage_warnings
    ...
    def __init__(self, resource_id: str, settings: dict):
        ...
        * settings: a dictionary of resource metadata, usually obtained as a PudlResourceDescription model dump.
        """
    ...
    def _create_summary_description(self, settings, defaults: "ResourceNameComponents"):
        ...
        Any additional_summary_text, if present, is included after the standard text for the timeseries resolution and table type.
        If the timeseries resolution and table type aren't set manually and can't be auto detected, fall back to
        the additional_summary_text key and use it as a complete sentence instead of just a predicate fragment.
        """
    ...
    def _create_x_description(
        ...
        Arguments:
        * attr: name of the key (exclude the _code suffix) for the category code for this component (shared with ResourceNameComponents)
        ...
        * defaults: a ResourceNameComponents instance for this resource, containing the default category codes as extracted from the resource id
        """
