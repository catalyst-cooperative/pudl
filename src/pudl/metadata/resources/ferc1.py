...
any cleaning mechanisms in place to account for this."""
    ...
    "denorm_plants_steam_ferc1": {
        ...
        "schema": {
            "fields": [
                ...
                "capacity_factor",
                "capacity_mw",
                # "capex_annual_addition", # All commented out fields would need to be added to metadata
    ...
    "denorm_purchased_power_ferc1": {
        ...
        "schema": {
            ...
            # This doesn't seem right but more obv combos aren't unique - flag for review.
    ...
    #             "total_settlement",
    #         ],
    #         # This doesn't seem right - flag for review.
    #         "primary_key": ["report_year", "record_id", "total_settlement"],
    #     },
    #     "sources": ["ferc1"],
    #     "etl_group": "outputs",
