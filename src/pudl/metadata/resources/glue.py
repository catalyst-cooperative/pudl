...
""",
    ...
    # "ferc1_eia": {
    #     "description": """This table connects FERC1 plant tables to EIA's plant-parts
    # via record linkage. It is reported
    ...
    # plants with ids reported in *seperate* tables. What a joy. In plant_parts_eia, we've
    # generated the EIA plant-parts. The EIA plant-parts generated records for various levels
    # or granularities of plant parts.
