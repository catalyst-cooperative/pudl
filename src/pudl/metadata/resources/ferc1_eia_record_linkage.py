...
plants with ids reported in *seperate* tables. What a joy. In order to link FERC records
to EIA, we've generated the EIA plant-parts (plant_parts_eia) table. The EIA plant-parts
are generated by aggregating generator records into various levels or granularities of
plant parts.
This table is the result of a record linkage process that chooses the best EIA plant-part
record to link to FERC1 plant records. The output includes all FERC plant data as its
reported associated with a single EIA plant-part record which includes EIA data that
is aggregated to that "plant_part" level.
""",
        "schema": {
            "fields": [
                "record_id_ferc1",
