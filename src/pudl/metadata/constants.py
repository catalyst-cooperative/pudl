...
XBRL_TABLES = [
    ...
    "statement_of_cash_flows_other_payment_for_retirement_to_financing_activities_120_duration",
    "statement_of_cash_flows_other_payment_for_retirement_to_financing_activities_120_instant",
