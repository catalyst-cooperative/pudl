...
@pytest.mark.parametrize(
    "cases",
    [
        pytest.param(pv.core_ferc1__yearly_steam_plants_capacity, id="capacity"),
        pytest.param(pv.core_ferc1__yearly_steam_plants_expenses, id="expenses"),
        pytest.param(
            pv.core_ferc1__yearly_steam_plants_capacity_ratios, id="capacity_ratios"
        ),
        pytest.param(
...
def test_vs_bounds(pudl_out_ferc1, live_dbs, cases):
    """Test distributions of reported core_ferc1__yearly_steam_plants columns."""
    if not live_dbs:
...
def test_self_vs_historical(pudl_out_ferc1, live_dbs):
    ...
    for args in pv.core_ferc1__yearly_steam_plants_self:
