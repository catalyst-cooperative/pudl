...
table_a,fact_2,table_b,fact_5,,futile
table_a,fact_2,table_b,fact_6,,futile
table_a,fact_2,table_b,fact_7,,
"""
        )
    )
    table_dimensions_st = pd.read_csv(
        StringIO(
            """
...
table_a,fact_4,ds9,coffee
table_a,fact_4,ds9,in
table_a,fact_4,ds9,that
table_a,fact_4,ds9,nebula
table_b,fact_5,next_gen,resistance
table_b,fact_5,next_gen,is
table_b,fact_5,next_gen,futile
...
table_a,fact_2,table_b,fact_5,next_gen,futile
table_a,fact_2,table_b,fact_6,next_gen,futile
table_a,fact_2,table_b,fact_7,next_gen,resistance
table_a,fact_2,table_b,fact_7,next_gen,is
