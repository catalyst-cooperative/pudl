...
"""
    ...
    expected_total_to_subdim = canonicalize(
        pd.read_csv(
            StringIO(
                """
table_name_parent,xbrl_factoid_parent,dim_x_parent,dim_y_parent,table_name,xbrl_factoid,dim_x,dim_y,is_within_table_calc
table_a,fact_1,voyager,coffee,table_a,fact_3,voyager,coffee,True
table_a,fact_1,voyager,in,table_a,fact_3,voyager,in,True
table_a,fact_1,voyager,that,table_a,fact_3,voyager,that,True
table_a,fact_1,voyager,nebula,table_a,fact_3,voyager,nebula,True
table_a,fact_1,voyager,total,table_a,fact_3,voyager,total,True
table_a,fact_1,voyager,total,table_a,fact_1,voyager,coffee,NA
table_a,fact_1,voyager,total,table_a,fact_1,voyager,in,NA
table_a,fact_1,voyager,total,table_a,fact_1,voyager,that,NA
table_a,fact_1,voyager,total,table_a,fact_1,voyager,nebula,NA
table_a,fact_3,voyager,total,table_a,fact_3,voyager,coffee,NA
table_a,fact_3,voyager,total,table_a,fact_3,voyager,in,NA
table_a,fact_3,voyager,total,table_a,fact_3,voyager,that,NA
table_a,fact_3,voyager,total,table_a,fact_3,voyager,nebula,NA
"""
            )
        )
    )
...
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,steam_production
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,general
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,steam_production
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,general
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,steam_production,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,steam_production
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,steam_production,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,steam_production
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,general,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,general
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,total,general,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,general
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,steam_production
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,in_service,general
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,steam_production
electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,total,electric_plant_depreciation_change_ferc1,accumulated_depreciation,electric,future,general
"""
            )
        )
    )
