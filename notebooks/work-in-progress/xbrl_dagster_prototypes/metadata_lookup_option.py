"""
To run this script: `python notebooks/work-in-progress/xbrl_dagster_prototypes/metadata_lookup_option.py`

or to view in Dagit:
`dagit -f notebooks/work-in-progress/xbrl_dagster_prototypes/metadata_lookup_option.py`
"""
import pandas as pd
...
def rename_columns_factory(
    ...
    **kwargs,
    ...
    @op(name=op_name, ins=ins, **kwargs)
