...
@pytest.mark.parametrize(
    ...
    [
        ...
        "pudl_datastore ferc60 --bypass-local-cache --partition year=2020",
        # Force the download of one small partition from GCS
        "pudl_datastore ferc60 --bypass-local-cache --cloud-cache-path s3://pudl.catalyst.coop/zenodo --partition year=2020",
        # Exercise the datastore validation code
        "pudl_datastore ferc60 --validate --partition year=2020",
        # Ensure that all data source partitions are legible
        "pudl_datastore ferc60 eia860 --list-partitions --cloud-cache-path s3://pudl.catalyst.coop/zenodo",
    ],
)
