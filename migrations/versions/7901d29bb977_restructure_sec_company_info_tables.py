...
Revision ID: 7901d29bb977
Revises: b2acd10c5d2b
Create Date: 2025-03-06 13:13:42.221165
...
def upgrade() -> None:
    ...
    sa.Column('company_name', sa.Text(), nullable=False, comment='Name of company submitting SEC 10k filing.'),
    sa.Column('name_change_date', sa.Date(), nullable=True, comment='Date of last name change of the company.'),
    sa.PrimaryKeyConstraint('central_index_key', 'company_name', name=op.f('pk_core_sec10k__changelog_company_name'))
    )
