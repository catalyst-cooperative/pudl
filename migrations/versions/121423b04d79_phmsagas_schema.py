...
Revision ID: 121423b04d79
Revises: 76397c4db652
Create Date: 2025-09-23 13:51:14.171530
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('report_number', 'operator_id_phmsa', 'operating_state', 'install_decade', name=op.f('pk__core_phmsagas__yearly_distribution_by_install_decade'))
    )
    ...
    sa.PrimaryKeyConstraint('report_number', 'operator_id_phmsa', 'operating_state', 'damage_type', 'damage_sub_type', name=op.f('pk__core_phmsagas__yearly_distribution_excavation_damages'))
    )
    ...
    sa.PrimaryKeyConstraint('report_number', 'operator_id_phmsa', name=op.f('pk__core_phmsagas__yearly_distribution_filings'))
    )
    ...
    sa.PrimaryKeyConstraint('report_number', 'operator_id_phmsa', name=op.f('pk_core_phmsagas__yearly_distribution_operators'))
    )
