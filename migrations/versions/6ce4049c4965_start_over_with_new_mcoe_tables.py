"""Start over with new MCOE tables.

Revision ID: 6ce4049c4965
Revises:
Create Date: 2023-05-01 19:22:28.922803
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                "WNC", "MTN", "NEW", "MAT", "ESC", "PCC", "SAT", "PCN", "ENC", "WSC"
            ),
            nullable=True,
