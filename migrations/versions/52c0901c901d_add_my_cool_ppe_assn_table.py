...
Revision ID: 52c0901c901d
Revises: 52aa9f44b6a7
Create Date: 2024-08-20 16:03:36.256974
...
def upgrade() -> None:
    ...
    op.create_table('out_eia__yearly_plant_parts_plant_gen_assn',
    ...
    sa.ForeignKeyConstraint(['record_id_eia'], ['out_eia__yearly_plant_parts.record_id_eia'], name=op.f('fk_out_eia__yearly_plant_parts_plant_gen_assn_record_id_eia_out_eia__yearly_plant_parts')),
    sa.ForeignKeyConstraint(['record_id_eia_plant_gen'], ['out_eia__yearly_plant_parts.record_id_eia'], name=op.f('fk_out_eia__yearly_plant_parts_plant_gen_assn_record_id_eia_plant_gen_out_eia__yearly_plant_parts')),
    sa.PrimaryKeyConstraint('record_id_eia', 'record_id_eia_plant_gen', name=op.f('pk_out_eia__yearly_plant_parts_plant_gen_assn'))
    )
...
def downgrade() -> None:
    ...
    op.drop_table('out_eia__yearly_plant_parts_plant_gen_assn')
    # ### end Alembic commands ###
