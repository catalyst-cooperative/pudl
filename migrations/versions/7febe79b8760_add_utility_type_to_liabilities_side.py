...
def upgrade() -> None:
    ...
    with op.batch_alter_table('balance_sheet_liabilities_ferc1', schema=None) as batch_op:
    ...
    with op.batch_alter_table('denorm_balance_sheet_liabilities_ferc1', schema=None) as batch_op:
        batch_op.add_column(sa.Column('utility_type', sa.Text(), nullable=True, comment='Listing of utility plant types. Examples include Electric Utility, Gas Utility, and Other Utility.'))
