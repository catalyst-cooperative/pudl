...
Revision ID: 0599d4f26079
Revises: e0d3904b97f4
Create Date: 2024-04-26 17:13:12.990034
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['balancing_authority_code_eia'], ['core_eia__codes_balancing_authorities.code'], name=op.f('fk_core_eia930__hourly_balancing_authority_subregion_demand_balancing_authority_code_eia_core_eia__codes_balancing_authorities')),
    sa.PrimaryKeyConstraint('datetime_utc', 'balancing_authority_code_eia', 'subregion_code_eia', name=op.f('pk_core_eia930__hourly_balancing_authority_subregion_demand'))
    )
    ...
    with op.batch_alter_table('core_eia__codes_balancing_authorities', schema=None) as batch_op:
        batch_op.add_column(sa.Column('region_code_eia', sa.Enum('NW', 'FLA', 'CAR', 'MEX', 'SE', 'SW', 'CAL', 'CENT', 'MIDW', 'TEX', 'CAN', 'NE', 'MIDA', 'NY'), nullable=True, comment='EIA region code.'))
