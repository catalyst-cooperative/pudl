"""rus - add output tables

Revision ID: b115e6d2dcc0
Revises: bec09b01456e
Create Date: 2026-03-12 11:36:10.799471
...
def upgrade() -> None:
    ...
    sa.Column('state', sa.Enum('AL', 'SC', 'DC', 'NB', 'LA', 'AB', 'MO', 'NC', 'PA', 'NU', 'MS', 'UT', 'VA', 'NV', 'PE', 'AZ', 'OH', 'MH', 'OR', 'AK', 'IN', 'NT', 'CA', 'ID', 'WY', 'RI', 'MD', 'MN', 'CT', 'MA', 'ME', 'VI', 'KY', 'FM', 'AS', 'PR', 'NL', 'WI', 'DE', 'IA', 'IL', 'MP', 'NJ', 'OK', 'QC', 'AR', 'NH', 'GU', 'HI', 'NS', 'WV', 'SD', 'MI', 'ON', 'MT', 'YT', 'CO', 'SK', 'MB', 'NM', 'VT', 'ND', 'TN', 'GA', 'TX', 'FL', 'NY', 'BC', 'WA', 'KS', 'NE'), nullable=True, comment='Two letter US state or territory abbreviation, or ISO 3166-1 alpha-two code for Micronesia and the Marshall Islands.'),
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_balance_sheet_assets_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.Column('balance', sa.Text(), nullable=True, comment='Indication of whether a column is a credit or debit, as reported in the XBRL taxonomy.'),
    sa.Column('is_total', sa.Boolean(), nullable=True, comment='Whether or not this record represents a total.'),
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_balance_sheet_liabilities_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_external_financial_risk_ratio_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_investments_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_lines_stations_labor_materials_cost_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_loans_borrower_id_rus_core_rus7__entity_borrowers'))
    )
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_long_term_debt_borrower_id_rus_core_rus7__entity_borrowers'))
    )
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_meeting_and_board_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.Column('is_total', sa.Boolean(), nullable=True, comment='Whether or not this record represents a total.'),
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_plant_costs_borrower_id_rus_core_rus7__entity_borrowers'))
    )
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_plant_labor_borrower_id_rus_core_rus7__entity_borrowers'))
    )
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_plant_operations_by_borrower_borrower_id_rus_core_rus7__entity_borrowers'))
    )
    ...
    sa.Column('operating_hours_out_of_service_unscheduled', sa.Float(), nullable=True, comment='Number of operating hours out of service which were unscheduled.'),
    sa.Column('times_started', sa.Float(), nullable=True, comment="Number of times the plant was started. This field is only reported for plant_type's steam and nuclear."),
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_plant_operations_by_plant_borrower_id_rus_core_rus7__entity_borrowers'))
    )
    ...
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_renewable_plants_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.Column('cost', sa.Float(), nullable=True, comment='Cost value.'),
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_sources_and_distribution_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.Column('cost', sa.Float(), nullable=True, comment='Cost value.'),
    sa.Column('net_energy_received_mwh', sa.Float(), nullable=True, comment='The net amount of energy received into the system.'),
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_sources_and_distribution_by_plant_type_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.Column('is_total', sa.Boolean(), nullable=True, comment='Whether or not this record represents a total.'),
    sa.ForeignKeyConstraint(['borrower_id_rus'], ['core_rus7__entity_borrowers.borrower_id_rus'], name=op.f('fk_out_rus12__yearly_statement_of_operations_borrower_id_rus_core_rus7__entity_borrowers')),
    ...
    sa.Column('report_date', sa.Date(), nullable=False, comment='Date reported.'),
    sa.Column('borrower_id_rus', sa.Text(), nullable=False, comment="Unique identifier of RUS (Rural Utilities Service) borrower. These ID's are structured as: two character state acronyms followed by four digits."),
    sa.Column('customer_class', sa.Enum('irrigation', 'residential_seasonal', 'sales_for_resale_other', 'sales_for_resale_rus_borrowers', 'total', 'transmission', 'public_other', 'residential_excluding_seasonal', 'commercial_and_industrial_large', 'commercial_and_industrial_small', 'other_electric', 'public_street_lighting'), nullable=False, comment='High level categorization of customer type.'),
    sa.Column('observation_period', sa.Enum('ytd_budget', 'new_in_report_year', 'report_year', 'cumulative', 'ytd', 'december', 'avg', 'report_month'), nullable=False, comment="The date range that any given record pertains to. Ex: 'december' implies that this record covers the month of December only, while 'avg' implies this record pertains to the average of the reporting period."),
    ...
    sa.Column('report_date', sa.Date(), nullable=False, comment='Date reported.'),
    sa.Column('borrower_id_rus', sa.Text(), nullable=False, comment="Unique identifier of RUS (Rural Utilities Service) borrower. These ID's are structured as: two character state acronyms followed by four digits."),
    sa.Column('patronage_type', sa.Enum('total_distributions_retirements', 'distributions_general_retirements', 'total_received', 'distributions_special_retirements', 'received_lenders_of_electric_power', 'received_supplier_of_electric_power'), nullable=False, comment='Type of patronage capital distributed or received.'),
