...
Revision ID: cfa8ea66ecb7
Revises: a4e2078b82ee
Create Date: 2026-03-02 18:24:33.376671
...
def upgrade() -> None:
    ...
    op.create_table('core_rus7__yearly_loan_guarantees',
...
def downgrade() -> None:
    ...
    op.drop_table('core_rus7__yearly_loan_guarantees')
    # ### end Alembic commands ###
