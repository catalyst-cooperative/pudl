...
def upgrade() -> None:
    ...
    sa.Column('disposal_landfill_tons_or_mmbtu', sa.Float(), nullable=True, comment='Disposed by-products in landfill, to the nearest hundred tons or in MMBtu for steam sales.'),
    sa.Column('disposal_offsite_tons_or_mmbtu', sa.Float(), nullable=True, comment='Disposed by-products offsite, to the nearest hundred tons or in MMBtu for steam sales.'),
    sa.Column('disposal_ponds_tons_or_mmbtu', sa.Float(), nullable=True, comment='Disposed by-products in ponds, to the nearest hundred tons or in MMBtu for steam sales.z'),
    sa.Column('sold_tons_or_mmbtu', sa.Float(), nullable=True, comment='Sold by-products, in tons (to the nearest 100 tons) or, for Steam, MMBtu.'),
    sa.Column('stored_offsite_tons_or_mmbtu', sa.Float(), nullable=True, comment='Stored by-products offsite, to the nearest hundred tons or in MMBtu for steam sales.'),
    sa.Column('stored_onsite_tons_or_mmbtu', sa.Float(), nullable=True, comment='Stored by-products onsite, to the nearest hundred tons or in MMBtu for steam sales.'),
    sa.Column('used_offsite_tons_or_mmbtu', sa.Float(), nullable=True, comment='Used offsite by-products, to the nearest hundred tons or in MMBtu for steam sales.'),
    sa.Column('used_onsite_tons_or_mmbtu', sa.Float(), nullable=True, comment='Used onsite by-products, to the nearest hundred tons or in MMBtu for steam sales.'),
    sa.Column('total_disposal_tons_or_mmbtu', sa.Float(), nullable=True, comment='Total by-product disposal, to the nearest hundred tons or in MMBtu for steam sales.'),
