...
Revision ID: 3ef28b161181
Revises: 9a8d47bd495e
Create Date: 2026-07-11 00:41:34.337957
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('core_ferc1__yearly_transmission_lines_sched422', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('supporting_structure_material', sa.Enum('steel', 'wood', 'concrete', 'aluminum'), nullable=True, comment='Material used in the supporting structure for the transmission line. Categorized values: steel, wood, concrete, aluminum. Only filled for unambiguous values; set to NA for multi-category or ambiguous values.'))
