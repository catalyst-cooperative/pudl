"""Restructure SEC 10k tables

Revision ID: 0a087ea4fee8
Revises: b2acd10c5d2b
Create Date: 2025-03-03 21:49:01.529690
...
def upgrade() -> None:
    ...
    op.create_table('raw_sec10k__quarterly_company_information',
    ...
    sa.Column('report_date', sa.Date(), nullable=True, comment='The quarter in which the filing was submitted.'),
    sa.PrimaryKeyConstraint('filename_sec10k', 'filer_count', 'company_information_block', 'company_information_block_count', 'company_information_fact_name', 'company_information_fact_value', name=op.f('pk_raw_sec10k__quarterly_company_information'))
    )
...
def downgrade() -> None:
    ...
    op.drop_table('raw_sec10k__quarterly_company_information')
