...
Revision ID: 8c43d8bc088b
Revises: a4e2078b82ee
Create Date: 2026-03-03 14:52:48.013410
...
def upgrade() -> None:
    ...
    sa.Column('encumbrance_ratio', sa.Float(), nullable=True, comment='The ratio of investments and loan guarantees to total utility plant assets.Higher numbers indicate more risk with utility financial activity heavily reliant on external financing. Lower numbers indicate more conservative behavior and less exposure to risk.'),
