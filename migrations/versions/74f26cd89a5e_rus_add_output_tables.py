...
Revision ID: 74f26cd89a5e
Revises: 758a4b398eeb
Create Date: 2026-03-10 12:58:48.546225
...
def upgrade() -> None:
    ...
    sa.Column('state', sa.Enum('RI', 'SK', 'AL', 'MT', 'MA', 'VT', 'NL', 'WV', 'BC', 'MO', 'MD', 'HI', 'TX', 'WY', 'AZ', 'WA', 'ID', 'WI', 'YT', 'IA', 'NE', 'MP', 'GA', 'ND', 'ON', 'AS', 'DE', 'LA', 'PR', 'VA', 'NY', 'MS', 'FL', 'VI', 'NB', 'AR', 'NV', 'NS', 'SD', 'PE', 'ME', 'FM', 'AB', 'MN', 'NJ', 'MH', 'TN', 'OR', 'MI', 'NU', 'IL', 'KY', 'NT', 'DC', 'KS', 'NC', 'GU', 'NH', 'MB', 'CO', 'CT', 'OH', 'QC', 'AK', 'IN', 'OK', 'SC', 'PA', 'NM', 'UT', 'CA'), nullable=True, comment='Two letter US state or territory abbreviation, or ISO 3166-1 alpha-two code for Micronesia and the Marshall Islands.'),
    ...
    sa.Column('cost_group', sa.Enum('capex', 'opex', 'total'), nullable=True, comment='High-level category of cost type.'),
    ...
    sa.Column('report_date', sa.Date(), nullable=False, comment='Date reported.'),
    sa.Column('borrower_id_rus', sa.Text(), nullable=False, comment="Unique identifier of RUS (Rural Utilities Service) borrower. These ID's are structured as: two character state acronyms followed by four digits."),
    sa.Column('customer_class', sa.Enum('other_electric', 'public_street_lighting', 'sales_for_resale_other', 'transmission', 'commercial_and_industrial_large', 'commercial_and_industrial_small', 'total', 'sales_for_resale_rus_borrowers', 'irrigation', 'residential_excluding_seasonal', 'residential_seasonal', 'public_other'), nullable=False, comment='High level categorization of customer type.'),
    sa.Column('observation_period', sa.Enum('ytd', 'avg', 'report_year', 'cumulative', 'new_in_report_year', 'december', 'report_month', 'ytd_budget'), nullable=False, comment="The date range that any given record pertains to. Ex: 'december' implies that this record covers the month of December only, while 'avg' implies this record pertains to the average of the reporting period."),
    ...
    sa.ForeignKeyConstraint(['investment_type_code'], ['core_rus7__codes_investment_types.code'], name=op.f('fk_out_rus7__yearly_investments_investment_type_code_core_rus7__codes_investment_types'))
    )
    ...
    sa.Column('report_date', sa.Date(), nullable=False, comment='Date reported.'),
    sa.Column('borrower_id_rus', sa.Text(), nullable=False, comment="Unique identifier of RUS (Rural Utilities Service) borrower. These ID's are structured as: two character state acronyms followed by four digits."),
    sa.Column('patronage_type', sa.Enum('total_received', 'received_supplier_of_electric_power', 'distributions_special_retirements', 'received_lenders_of_electric_power', 'distributions_general_retirements', 'total_distributions_retirements'), nullable=False, comment='Type of patronage capital distributed or received.'),
