...
def upgrade() -> None:
    ...
    sa.Column('is_other_ownership_2', sa.Boolean(), nullable=True, comment='Secondary other-ownership indicator. Present only in 2016 data.'),
    ...
    sa.Column('is_public_liquid_natural_gas_fueling_station', sa.Boolean(), nullable=True, comment='Whether the company operates a public liquefied natural gas (LNG) fueling station.'),
