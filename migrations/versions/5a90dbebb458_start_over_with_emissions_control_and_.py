"""Start over with emissions control and gen fuel.

Revision ID: 5a90dbebb458
Revises:
Create Date: 2023-05-21 14:08:39.993485
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                "ENC", "PCN", "PCC", "NEW", "SAT", "MTN", "WNC", "WSC", "ESC", "MAT"
            ),
            nullable=True,
