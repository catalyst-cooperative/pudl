...
Revision ID: f3db07aa9714
Revises:
Create Date: 2023-04-07 11:23:44.397128
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                "ESC", "MTN", "ENC", "NEW", "PCN", "WSC", "WNC", "MAT", "PCC", "SAT"
            ),
            nullable=True,
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "plant_id_eia", "report_date", "energy_source_code", "prime_mover_code"
        ),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            "business_model", sa.Enum("retail", "energy_services"), nullable=True
        ),
        sa.Column(
            "data_observed",
            sa.Boolean(),
        ...
        sa.Column(
            "service_type", sa.Enum("bundled", "energy", "delivery"), nullable=True
        ),
        sa.Column("short_form", sa.Boolean(), nullable=True),
        sa.Column(
            "utility_name_eia",
