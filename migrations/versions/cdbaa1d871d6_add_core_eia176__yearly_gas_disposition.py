...
Revision ID: cdbaa1d871d6
Revises: a08df6e8711c
Create Date: 2025-11-21 09:05:33.249704
...
def upgrade() -> None:
    ...
    sa.Column('heat_content_of_delivered_gas_btu_cf', sa.Float(), nullable=True, comment='The average annual heat content of gas delivered directly to consumers.'),
    ...
    sa.Column('operational_consumption_vehicles_mcf', sa.Float(), nullable=True, comment="Volume of natural gas used in the operator's company-owned fleet within the report state. Reference conditions for measurement are 14.73 psia and 60° Fahrenheit."),
    ...
    sa.Column('total_disposition_mcf', sa.Float(), nullable=True, comment='Total disposition within the report state. Reference conditions for measurement are 14.73 psia and 60° Fahrenheit.'),
