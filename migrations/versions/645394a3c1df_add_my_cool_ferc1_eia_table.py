...
Revision ID: 645394a3c1df
Revises: 7fa2763bd630
Create Date: 2023-10-13 11:25:59.911198
...
def upgrade() -> None:
    ...
    op.create_table('ferc1_eia',
    sa.Column('record_id_ferc1', sa.Text(), nullable=False),
    ...
    sa.Column('plant_part', sa.Enum('plant_ferc_acct', 'plant_operating_year', 'plant_prime_fuel', 'plant_gen', 'plant_match_ferc1', 'plant_unit', 'plant_technology', 'plant', 'plant_prime_mover'), nullable=True, comment='The part of the plant a record corresponds to.'),
    ...
    sa.Column('appro_part_label', sa.Enum('plant_ferc_acct', 'plant_operating_year', 'plant_prime_fuel', 'plant_gen', 'plant_match_ferc1', 'plant_unit', 'plant_technology', 'plant', 'plant_prime_mover'), nullable=True, comment='Plant part of the associated true granularity record.'),
    ...
    sa.PrimaryKeyConstraint('record_id_eia', 'record_id_ferc1', name=op.f('pk_ferc1_eia'))
    )
