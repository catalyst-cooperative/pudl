...
Revision ID: be4a277a97a6
Revises: a4e2078b82ee
Create Date: 2026-02-27 15:06:05.581972
...
def upgrade() -> None:
    ...
    sa.Column('lending_organization', sa.Text(), nullable=True, comment='The organization that provided a lease.'),
