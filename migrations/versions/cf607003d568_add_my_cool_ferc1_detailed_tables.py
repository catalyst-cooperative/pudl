...
Revision ID: cf607003d568
Revises: 1e2ec7bf2b64
Create Date: 2025-02-12 15:17:50.873978
...
def upgrade() -> None:
    ...
    op.create_table('out_ferc1__detailed_income_statements',
    ...
    sa.ForeignKeyConstraint(['utility_id_ferc1'], ['core_pudl__assn_ferc1_pudl_utilities.utility_id_ferc1'], name=op.f('fk_out_ferc1__detailed_income_statements_utility_id_ferc1_core_pudl__assn_ferc1_pudl_utilities'))
    )
...
def downgrade() -> None:
    ...
    op.drop_table('out_ferc1__detailed_income_statements')
    # ### end Alembic commands ###
