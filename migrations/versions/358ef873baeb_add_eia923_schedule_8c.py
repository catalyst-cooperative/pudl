"""Add EIA923 Schedule 8C

Revision ID: 358ef873baeb
Revises: 9e1194f1487c
Create Date: 2026-03-04 10:25:22.016609
...
def upgrade() -> None:
    ...
    sa.Column('acid_gas_removal_efficiency_pct', sa.Float(), nullable=True, comment='Percent removal efficiency for acid gas emissions'),
    ...
    sa.Column('mercury_removal_efficiency_pct', sa.Float(), nullable=True, comment='Percent removal efficiency for mercury emissions rounded to nearest 0.1 percent of weight'),
    ...
    sa.PrimaryKeyConstraint('plant_id_eia', 'report_date', name=op.f('pk__core_eia923__yearly_emissions_control'))
    )
