...
: FERC data is notoriously difficult to extract cleanly, and often contains
  ...
  Irregularities](https://docs.catalyst.coop/pudl/en/latest/data_sources/ferc1.html#notable-irregularities)
  for details.
...
: Data has been drawn from several EIA sources which are not always consistent
  ...
  See [Entity Resolution](../methodology/entity_resolution.html.md) for a conceptual overview.
  <br/>
