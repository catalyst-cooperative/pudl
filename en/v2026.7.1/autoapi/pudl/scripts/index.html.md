...
- **Use Click-native exits**: command bodies should not return integer status
  codes expecting Click to turn them into process exit codes. Use
  `ctx.exit(code)` or raise `click.ClickException` / `click.UsageError`
  for non-zero exits. Keep the module launcher as `if __name__ ==
  "__main__": main()`.
...
* [pudl.scripts.auto_match_utilities](auto_match_utilities/index.md)
* [pudl.scripts.check_path_permissions](check_path_permissions/index.md)
* [pudl.scripts.dbt_helper](dbt_helper/index.md)
* [pudl.scripts.dghome](dghome/index.md)
* [pudl.scripts.generate_ferc_provenance](generate_ferc_provenance/index.md)
* [pudl.scripts.generate_pudl_duckdb](generate_pudl_duckdb/index.md)
* [pudl.scripts.metadata_to_rst](metadata_to_rst/index.md)
* [pudl.scripts.pudl_check_fks](pudl_check_fks/index.md)
* [pudl.scripts.pudl_check_for_build](pudl_check_for_build/index.md)
* [pudl.scripts.pudl_datastore](pudl_datastore/index.md)
* [pudl.scripts.pudl_deploy](pudl_deploy/index.md)
* [pudl.scripts.pudl_null_cols](pudl_null_cols/index.md)
* [pudl.scripts.pudl_service_territories](pudl_service_territories/index.md)
* [pudl.scripts.resource_description](resource_description/index.md)
* [pudl.scripts.update_zenodo_dois](update_zenodo_dois/index.md)
* [pudl.scripts.zenodo_data_release](zenodo_data_release/index.md)
