...
in [`pudl.transform.classes`](../classes/index.md#module-pudl.transform.classes). Their design and relationships to each other are
documented in that module.

See [`pudl.transform.params.ferc1`](../params/ferc1/index.md#module-pudl.transform.params.ferc1) for the values that parameterize many of these
transformations.

## Attributes

| [`logger`](#pudl.transform.ferc1.logger)                           |    |
|--------------------------------------------------------------------|----|
| [`FERC1_TFR_CLASSES`](#pudl.transform.ferc1.FERC1_TFR_CLASSES)     |    |
| [`_FERC1_PLANT_TABLES`](#pudl.transform.ferc1._FERC1_PLANT_TABLES) |    |
| [`ferc1_assets`](#pudl.transform.ferc1.ferc1_assets)               |    |

## Classes

| [`SourceFerc1`](#pudl.transform.ferc1.SourceFerc1)                                                                 | Enumeration of allowed FERC 1 raw data sources.                                                                                                                                            |
|--------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`TableIdFerc1`](#pudl.transform.ferc1.TableIdFerc1)                                                               | Enumeration of the allowed FERC 1 table IDs.                                                                                                                                               |
| [`RenameColumnsFerc1`](#pudl.transform.ferc1.RenameColumnsFerc1)                                                   | Dictionaries for renaming either XBRL or DBF derived FERC 1 columns.                                                                                                                       |
| [`WideToTidy`](#pudl.transform.ferc1.WideToTidy)                                                                   | Parameters for converting a wide table to a tidy table with value types.                                                                                                                   |
| [`WideToTidySourceFerc1`](#pudl.transform.ferc1.WideToTidySourceFerc1)                                             | Parameters for converting either or both XBRL and DBF table from wide to tidy.                                                                                                             |
| [`MergeXbrlMetadata`](#pudl.transform.ferc1.MergeXbrlMetadata)                                                     | Parameters for merging in XBRL metadata.                                                                                                                                                   |
| [`DropDuplicateRowsDbf`](#pudl.transform.ferc1.DropDuplicateRowsDbf)                                               | Parameter for dropping duplicate DBF rows.                                                                                                                                                 |
| [`AlignRowNumbersDbf`](#pudl.transform.ferc1.AlignRowNumbersDbf)                                                   | Parameters for aligning DBF row numbers with metadata from manual maps.                                                                                                                    |
| [`SelectDbfRowsByCategory`](#pudl.transform.ferc1.SelectDbfRowsByCategory)                                         | Parameters for [`select_dbf_rows_by_category()`](#pudl.transform.ferc1.select_dbf_rows_by_category).                                                                                       |
| [`UnstackBalancesToReportYearInstantXbrl`](#pudl.transform.ferc1.UnstackBalancesToReportYearInstantXbrl)           | Parameters for [`unstack_balances_to_report_year_instant_xbrl()`](#pudl.transform.ferc1.unstack_balances_to_report_year_instant_xbrl).                                                     |
| [`CombineAxisColumnsXbrl`](#pudl.transform.ferc1.CombineAxisColumnsXbrl)                                           | Parameters for [`combine_axis_columns_xbrl()`](#pudl.transform.ferc1.combine_axis_columns_xbrl).                                                                                           |
| [`AssignQuarterlyDataToYearlyDbf`](#pudl.transform.ferc1.AssignQuarterlyDataToYearlyDbf)                           | Parameters for transferring quarterly reported data to annual columns.                                                                                                                     |
| [`AddColumnWithUniformValue`](#pudl.transform.ferc1.AddColumnWithUniformValue)                                     | Parameters for adding a column to a table with a single value.                                                                                                                             |
| [`AddColumnsWithUniformValues`](#pudl.transform.ferc1.AddColumnsWithUniformValues)                                 | Parameters for adding columns to a table with a single value.                                                                                                                              |
| [`IsCloseTolerance`](#pudl.transform.ferc1.IsCloseTolerance)                                                       | Info for testing a particular check.                                                                                                                                                       |
| [`CalculationIsCloseTolerance`](#pudl.transform.ferc1.CalculationIsCloseTolerance)                                 | Calc params organized by check type.                                                                                                                                                       |
| [`MetricTolerances`](#pudl.transform.ferc1.MetricTolerances)                                                       | Tolerances for all data checks to be preformed within a grouped df.                                                                                                                        |
| [`GroupMetricTolerances`](#pudl.transform.ferc1.GroupMetricTolerances)                                             | Data quality expectations related to FERC 1 calculations.                                                                                                                                  |
| [`GroupMetricChecks`](#pudl.transform.ferc1.GroupMetricChecks)                                                     | Input for checking calculations organized by group and test.                                                                                                                               |
| [`ReconcileTableCalculations`](#pudl.transform.ferc1.ReconcileTableCalculations)                                   | Parameters for reconciling xbrl-metadata based calculations within a table.                                                                                                                |
| [`ErrorMetric`](#pudl.transform.ferc1.ErrorMetric)                                                                 | Base class for checking a particular metric within a group.                                                                                                                                |
| [`ErrorFrequency`](#pudl.transform.ferc1.ErrorFrequency)                                                           | Check error frequency in XBRL calculations.                                                                                                                                                |
| [`RelativeErrorMagnitude`](#pudl.transform.ferc1.RelativeErrorMagnitude)                                           | Check relative magnitude of errors in XBRL calculations.                                                                                                                                   |
| [`AbsoluteErrorMagnitude`](#pudl.transform.ferc1.AbsoluteErrorMagnitude)                                           | Check absolute magnitude of errors in XBRL calculations.                                                                                                                                   |
| [`NullCalculatedValueFrequency`](#pudl.transform.ferc1.NullCalculatedValueFrequency)                               | Check the frequency of null calculated values.                                                                                                                                             |
| [`NullReportedValueFrequency`](#pudl.transform.ferc1.NullReportedValueFrequency)                                   | Check the frequency of null reported values.                                                                                                                                               |
| [`Ferc1TableTransformParams`](#pudl.transform.ferc1.Ferc1TableTransformParams)                                     | A model defining what TransformParams are allowed for FERC Form 1.                                                                                                                         |
| [`Ferc1AbstractTableTransformer`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer)                             | An abstract class defining methods common to many FERC Form 1 tables.                                                                                                                      |
| [`IdentificationCertificationTableTransformer`](#pudl.transform.ferc1.IdentificationCertificationTableTransformer) | Transformer class for the [core_ferc1_\_yearly_identification_certification](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-identification-certification) table.               |
| [`SteamPlantsFuelTableTransformer`](#pudl.transform.ferc1.SteamPlantsFuelTableTransformer)                         | A table transformer specific to the [core_ferc1_\_yearly_steam_plants_fuel_sched402](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-steam-plants-fuel-sched402) table.         |
| [`SteamPlantsTableTransformer`](#pudl.transform.ferc1.SteamPlantsTableTransformer)                                 | Transformer class for the [core_ferc1_\_yearly_steam_plants_sched402](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-steam-plants-sched402) table.                             |
| [`HydroelectricPlantsTableTransformer`](#pudl.transform.ferc1.HydroelectricPlantsTableTransformer)                 | A table transformer specific to the [core_ferc1_\_yearly_hydroelectric_plants_sched406](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-hydroelectric-plants-sched406) table.   |
| [`PumpedStoragePlantsTableTransformer`](#pudl.transform.ferc1.PumpedStoragePlantsTableTransformer)                 | Transformer class for [core_ferc1_\_yearly_pumped_storage_plants_sched408](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-pumped-storage-plants-sched408) table.               |
| [`PurchasedPowerAndExchangesTableTransformer`](#pudl.transform.ferc1.PurchasedPowerAndExchangesTableTransformer)   | Transformer class for [core_ferc1_\_yearly_purchased_power_and_exchanges_sched326](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-purchased-power-and-exchanges-sched326).     |
| [`PlantInServiceTableTransformer`](#pudl.transform.ferc1.PlantInServiceTableTransformer)                           | A transformer for the [core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204) table.                         |
| [`SmallPlantsTableTransformer`](#pudl.transform.ferc1.SmallPlantsTableTransformer)                                 | A table transformer specific to the [core_ferc1_\_yearly_small_plants_sched410](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-small-plants-sched410) table.                   |
| [`TransmissionLinesTableTransformer`](#pudl.transform.ferc1.TransmissionLinesTableTransformer)                     | A table transformer for the [core_ferc1_\_yearly_transmission_lines_sched422](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-transmission-lines-sched422) table.               |
| [`EnergySourcesTableTransformer`](#pudl.transform.ferc1.EnergySourcesTableTransformer)                             | Transformer class for [core_ferc1_\_yearly_energy_sources_sched401](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-energy-sources-sched401) table.                             |
| [`EnergyDispositionsTableTransformer`](#pudl.transform.ferc1.EnergyDispositionsTableTransformer)                   | Transformer class for [core_ferc1_\_yearly_energy_dispositions_sched401](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-energy-dispositions-sched401) table.                   |
| [`UtilityPlantSummaryTableTransformer`](#pudl.transform.ferc1.UtilityPlantSummaryTableTransformer)                 | Transformer class for [core_ferc1_\_yearly_utility_plant_summary_sched200](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-utility-plant-summary-sched200) table.               |
| [`BalanceSheetLiabilitiesTableTransformer`](#pudl.transform.ferc1.BalanceSheetLiabilitiesTableTransformer)         | Transformer class for [core_ferc1_\_yearly_balance_sheet_liabilities_sched110](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-balance-sheet-liabilities-sched110) table.       |
| [`BalanceSheetAssetsTableTransformer`](#pudl.transform.ferc1.BalanceSheetAssetsTableTransformer)                   | Transformer class for [core_ferc1_\_yearly_balance_sheet_assets_sched110](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-balance-sheet-assets-sched110) table.                 |
| [`IncomeStatementsTableTransformer`](#pudl.transform.ferc1.IncomeStatementsTableTransformer)                       | Transformer class for the [core_ferc1_\_yearly_income_statements_sched114](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-income-statements-sched114) table.                   |
| [`RetainedEarningsTableTransformer`](#pudl.transform.ferc1.RetainedEarningsTableTransformer)                       | Transformer class for [core_ferc1_\_yearly_retained_earnings_sched118](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-retained-earnings-sched118) table.                       |
| [`DepreciationSummaryTableTransformer`](#pudl.transform.ferc1.DepreciationSummaryTableTransformer)                 | Transformer class for [core_ferc1_\_yearly_depreciation_summary_sched336](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-summary-sched336) table.                 |
| [`DepreciationFactorsTransformer`](#pudl.transform.ferc1.DepreciationFactorsTransformer)                           | Transformer class for [core_ferc1_\_yearly_depreciation_factors_sched336](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-factors-sched336) table.                 |
| [`DepreciationChangesTableTransformer`](#pudl.transform.ferc1.DepreciationChangesTableTransformer)                 | Transformer class for [core_ferc1_\_yearly_depreciation_changes_sched219](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-changes-sched219) table.                 |
| [`DepreciationByFunctionTableTransformer`](#pudl.transform.ferc1.DepreciationByFunctionTableTransformer)           | Transformer for [core_ferc1_\_yearly_depreciation_by_function_sched219](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-by-function-sched219) table.               |
| [`OperatingExpensesTableTransformer`](#pudl.transform.ferc1.OperatingExpensesTableTransformer)                     | Transformer class for [core_ferc1_\_yearly_operating_expenses_sched320](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-operating-expenses-sched320) table.                     |
| [`OperatingRevenuesTableTransformer`](#pudl.transform.ferc1.OperatingRevenuesTableTransformer)                     | Transformer class for [core_ferc1_\_yearly_operating_revenues_sched300](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-operating-revenues-sched300) table.                     |
| [`CashFlowsTableTransformer`](#pudl.transform.ferc1.CashFlowsTableTransformer)                                     | Transform class for [core_ferc1_\_yearly_cash_flows_sched120](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-cash-flows-sched120) table.                                       |
| [`SalesByRateSchedulesTableTransformer`](#pudl.transform.ferc1.SalesByRateSchedulesTableTransformer)               | Transform class for [core_ferc1_\_yearly_sales_by_rate_schedules_sched304](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-sales-by-rate-schedules-sched304) table.             |
| [`OtherRegulatoryLiabilitiesTableTransformer`](#pudl.transform.ferc1.OtherRegulatoryLiabilitiesTableTransformer)   | Transformer class for [core_ferc1_\_yearly_other_regulatory_liabilities_sched278](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-other-regulatory-liabilities-sched278) table. |
| [`OtherRegulatoryAssetsTableTransformer`](#pudl.transform.ferc1.OtherRegulatoryAssetsTableTransformer)             | Transformer class for [core_ferc1_\_yearly_other_regulatory_assets_sched232](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-other-regulatory-assets-sched232) table.           |

## Functions

| [`_core_ferc1_xbrl__metadata_json`](#pudl.transform.ferc1._core_ferc1_xbrl__metadata_json)(→ dict[str, dict[str, ...)                 | Generate cleaned json xbrl metadata.                                                                                                        |
|---------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| [`add_missing_factoid`](#pudl.transform.ferc1.add_missing_factoid)(raw_ferc1_xbrl_\_metadata_json)                                    | Add one missing factoid from core_ferc1_\_yearly_operating_expenses_sched320.                                                               |
| [`add_source_tables_to_xbrl_metadata`](#pudl.transform.ferc1.add_source_tables_to_xbrl_metadata)(→ dict[str, ...)                     | Add a `source_tables` field into metadata calculation components.                                                                           |
| [`wide_to_tidy`](#pudl.transform.ferc1.wide_to_tidy)(→ pandas.DataFrame)                                                              | Reshape wide tables with FERC account columns to tidy format.                                                                               |
| [`merge_xbrl_metadata`](#pudl.transform.ferc1.merge_xbrl_metadata)(→ pandas.DataFrame)                                                | Merge metadata based on params.                                                                                                             |
| [`drop_duplicate_rows_dbf`](#pudl.transform.ferc1.drop_duplicate_rows_dbf)(→ pandas.DataFrame)                                        | Drop duplicate DBF rows if duplicates have identical data or one row has nulls.                                                             |
| [`align_row_numbers_dbf`](#pudl.transform.ferc1.align_row_numbers_dbf)(→ pandas.DataFrame)                                            | Rename the xbrl_factoid column after [`align_row_numbers_dbf()`](#pudl.transform.ferc1.align_row_numbers_dbf).                              |
| [`select_dbf_rows_by_category`](#pudl.transform.ferc1.select_dbf_rows_by_category)(→ pandas.DataFrame)                                | Select DBF rows with values listed or found in XBRL in a categorical-like column.                                                           |
| [`unstack_balances_to_report_year_instant_xbrl`](#pudl.transform.ferc1.unstack_balances_to_report_year_instant_xbrl)(...)             | Turn start year end year rows into columns for each value type.                                                                             |
| [`combine_axis_columns_xbrl`](#pudl.transform.ferc1.combine_axis_columns_xbrl)(→ pandas.DataFrame)                                    | Combine axis columns from squished XBRL tables into one column with no NAs.                                                                 |
| [`assign_quarterly_data_to_yearly_dbf`](#pudl.transform.ferc1.assign_quarterly_data_to_yearly_dbf)(→ pandas.DataFrame)                | Transfer 4th quarter reported data to the annual columns.                                                                                   |
| [`add_columns_with_uniform_values`](#pudl.transform.ferc1.add_columns_with_uniform_values)(→ pandas.DataFrame)                        | Add a column to a table with a single value.                                                                                                |
| [`reconcile_table_calculations`](#pudl.transform.ferc1.reconcile_table_calculations)(→ pandas.DataFrame)                              | Ensure intra-table calculated values match reported values within a tolerance.                                                              |
| [`reconcile_one_type_of_table_calculations`](#pudl.transform.ferc1.reconcile_one_type_of_table_calculations)(...)                     | Calculate vales, run metric checks and add corrections.                                                                                     |
| [`_calculation_components_subdimension_calculations`](#pudl.transform.ferc1._calculation_components_subdimension_calculations)(...)   | Add total to subdimension calculations into calculation components.                                                                         |
| [`_add_intra_table_calculation_dimensions`](#pudl.transform.ferc1._add_intra_table_calculation_dimensions)(→ pandas.DataFrame)        | Add all observed subdimensions into the calculation components.                                                                             |
| [`calculate_values_from_components`](#pudl.transform.ferc1.calculate_values_from_components)(→ pandas.DataFrame)                      | Apply calculations derived from XBRL metadata to reported XBRL data.                                                                        |
| [`check_calculation_metrics_by_group`](#pudl.transform.ferc1.check_calculation_metrics_by_group)(→ pandas.DataFrame)                  | Tabulate the results of the calculation checks by group.                                                                                    |
| [`check_calculation_metrics`](#pudl.transform.ferc1.check_calculation_metrics)(→ pandas.DataFrame)                                    | Run the calculation metrics and determine if calculations are within tolerance.                                                             |
| [`add_corrections`](#pudl.transform.ferc1.add_corrections)(→ pandas.DataFrame)                                                        | Add corrections to discrepancies between reported & calculated values.                                                                      |
| [`select_current_year_annual_records_duration_xbrl`](#pudl.transform.ferc1.select_current_year_annual_records_duration_xbrl)(df, ...) | Select for annual records within their report_year.                                                                                         |
| [`get_ferc1_dbf_rows_to_map`](#pudl.transform.ferc1.get_ferc1_dbf_rows_to_map)(→ pandas.DataFrame)                                    | Identify DBF rows that need to be mapped to XBRL columns.                                                                                   |
| [`update_dbf_to_xbrl_map`](#pudl.transform.ferc1.update_dbf_to_xbrl_map)(→ pandas.DataFrame)                                          | Regenerate the FERC 1 DBF+XBRL glue while retaining existing mappings.                                                                      |
| [`read_dbf_to_xbrl_map`](#pudl.transform.ferc1.read_dbf_to_xbrl_map)(→ pandas.DataFrame)                                              | Read the manually compiled DBF row to XBRL column mapping for a given table.                                                                |
| [`fill_dbf_to_xbrl_map`](#pudl.transform.ferc1.fill_dbf_to_xbrl_map)(→ pandas.DataFrame)                                              | Forward-fill missing years in the minimal, manually compiled DBF to XBRL mapping.                                                           |
| [`get_data_cols_raw_xbrl`](#pudl.transform.ferc1.get_data_cols_raw_xbrl)(→ list[str])                                                 | Get a list of all XBRL data columns appearing in a given XBRL table.                                                                        |
| [`read_xbrl_calculation_fixes`](#pudl.transform.ferc1.read_xbrl_calculation_fixes)(→ pandas.DataFrame)                                | Read in the table of calculation fixes.                                                                                                     |
| [`convert_pnynmndtnhnmns_to_years`](#pudl.transform.ferc1.convert_pnynmndtnhnmns_to_years)(dep_factors, life_col)                     | Convert the XBRL-based PnYnMnDTnHnMnS time period into years.                                                                               |
| [`ferc1_transform_asset_factory`](#pudl.transform.ferc1.ferc1_transform_asset_factory)(→ dagster.AssetsDefinition)                    | Create an asset that pulls in raw ferc Form 1 assets and applies transformations.                                                           |
...
| [`_core_ferc1_xbrl__calculation_components`](#pudl.transform.ferc1._core_ferc1_xbrl__calculation_components)(...)                     | Create calculation-component table from table-level metadata.                                                                               |
| [`unexpected_total_components`](#pudl.transform.ferc1.unexpected_total_components)(→ pandas.DataFrame)                                | Find unexpected components in within-fact total calculations.                                                                               |
| [`check_for_calc_components_duplicates`](#pudl.transform.ferc1.check_for_calc_components_duplicates)(→ None)                          | Check for duplicates calculation records.                                                                                                   |
| [`make_xbrl_factoid_dimensions_explicit`](#pudl.transform.ferc1.make_xbrl_factoid_dimensions_explicit)(→ pandas.DataFrame)            | Fill in null dimensions w/ the values observed in [`_core_ferc1__table_dimensions()`](#pudl.transform.ferc1._core_ferc1__table_dimensions). |
| [`assign_parent_dimensions`](#pudl.transform.ferc1.assign_parent_dimensions)(→ pandas.DataFrame)                                      | Add dimensions to calculation parents.                                                                                                      |
| [`infer_intra_factoid_totals`](#pudl.transform.ferc1.infer_intra_factoid_totals)(→ pandas.DataFrame)                                  | Define dimension total calculations.                                                                                                        |
| [`add_calculation_component_corrections`](#pudl.transform.ferc1.add_calculation_component_corrections)(→ pandas.DataFrame)            | Add records into the calculation components table.                                                                                          |
| [`_core_ferc1__calculation_metric_checks`](#pudl.transform.ferc1._core_ferc1__calculation_metric_checks)(\*\*kwargs)                  | Check calculation metrics for all transformed tables which have reconciled calcs.                                                           |
...
For now, this adds a missing factoid via [`add_missing_factoid()`](#pudl.transform.ferc1.add_missing_factoid)
and runs [`add_source_tables_to_xbrl_metadata()`](#pudl.transform.ferc1.add_source_tables_to_xbrl_metadata).

### pudl.transform.ferc1.add_missing_factoid(raw_ferc1_xbrl_\_metadata_json)

Add one missing factoid from core_ferc1_\_yearly_operating_expenses_sched320.
...
[`add_source_tables_to_xbrl_metadata()`](#pudl.transform.ferc1.add_source_tables_to_xbrl_metadata) adds sources tables to all of the
...
#### STEAM_PLANTS_FUEL *= 'core_ferc1_\_yearly_steam_plants_fuel_sched402'*

#### STEAM_PLANTS *= 'core_ferc1_\_yearly_steam_plants_sched402'*

#### HYDROELECTRIC_PLANTS *= 'core_ferc1_\_yearly_hydroelectric_plants_sched406'*

#### SMALL_PLANTS *= 'core_ferc1_\_yearly_small_plants_sched410'*

#### PUMPED_STORAGE_PLANTS *= 'core_ferc1_\_yearly_pumped_storage_plants_sched408'*

#### PLANT_IN_SERVICE *= 'core_ferc1_\_yearly_plant_in_service_sched204'*

#### PURCHASED_POWER_AND_EXCHANGES *= 'core_ferc1_\_yearly_purchased_power_and_exchanges_sched326'*

#### TRANSMISSION_LINES *= 'core_ferc1_\_yearly_transmission_lines_sched422'*

#### ENERGY_SOURCES *= 'core_ferc1_\_yearly_energy_sources_sched401'*

#### ENERGY_DISPOSITIONS *= 'core_ferc1_\_yearly_energy_dispositions_sched401'*

#### UTILITY_PLANT_SUMMARY *= 'core_ferc1_\_yearly_utility_plant_summary_sched200'*

#### OPERATING_EXPENSES *= 'core_ferc1_\_yearly_operating_expenses_sched320'*

#### BALANCE_SHEET_LIABILITIES *= 'core_ferc1_\_yearly_balance_sheet_liabilities_sched110'*

#### DEPRECIATION_SUMMARY *= 'core_ferc1_\_yearly_depreciation_summary_sched336'*

#### DEPRECIATION_FACTORS *= 'core_ferc1_\_yearly_depreciation_factors_sched336'*

#### BALANCE_SHEET_ASSETS *= 'core_ferc1_\_yearly_balance_sheet_assets_sched110'*

#### RETAINED_EARNINGS *= 'core_ferc1_\_yearly_retained_earnings_sched118'*

#### INCOME_STATEMENTS *= 'core_ferc1_\_yearly_income_statements_sched114'*

#### DEPRECIATION_CHANGES *= 'core_ferc1_\_yearly_depreciation_changes_sched219'*

#### OPERATING_REVENUES *= 'core_ferc1_\_yearly_operating_revenues_sched300'*

#### DEPRECIATION_BY_FUNCTION *= 'core_ferc1_\_yearly_depreciation_by_function_sched219'*

#### CASH_FLOWS *= 'core_ferc1_\_yearly_cash_flows_sched120'*

#### SALES_BY_RATE_SCHEDULES *= 'core_ferc1_\_yearly_sales_by_rate_schedules_sched304'*

#### OTHER_REGULATORY_LIABILITIES *= 'core_ferc1_\_yearly_other_regulatory_liabilities_sched278'*

#### IDENTIFICATION_CERTIFICATION *= 'core_ferc1_\_yearly_identification_certification'*

#### OTHER_REGULATORY_ASSETS *= 'core_ferc1_\_yearly_other_regulatory_assets_sched232'*

### *class* pudl.transform.ferc1.RenameColumnsFerc1(/, \*\*data: Any)

Bases: [`pudl.transform.classes.TransformParams`](../classes/index.md#pudl.transform.classes.TransformParams)
...
transform function. Like the generic [`pudl.transform.classes.RenameColumns`](../classes/index.md#pudl.transform.classes.RenameColumns)
it depends on the build in `pd.rename()` method, which is called with the values
...
#### dbf *: [pudl.transform.classes.RenameColumns](../classes/index.md#pudl.transform.classes.RenameColumns)*

#### xbrl *: [pudl.transform.classes.RenameColumns](../classes/index.md#pudl.transform.classes.RenameColumns)*

#### duration_xbrl *: [pudl.transform.classes.RenameColumns](../classes/index.md#pudl.transform.classes.RenameColumns)*

#### instant_xbrl *: [pudl.transform.classes.RenameColumns](../classes/index.md#pudl.transform.classes.RenameColumns)*

#### *property* rename_dicts_xbrl

Compile all of the XBRL rename dictionaries into an ordered list.

### *class* pudl.transform.ferc1.WideToTidy(/, \*\*data: Any)
...
categories.  In the input dataframe given to [`wide_to_tidy()`](#pudl.transform.ferc1.wide_to_tidy), the value types
...
`wide_to_tidy_xbrl()` will generate a regex pattern assuming the `value_types`
...
### *class* pudl.transform.ferc1.WideToTidySourceFerc1(/, \*\*data: Any)
...
### pudl.transform.ferc1.wide_to_tidy(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), params: [WideToTidy](#pudl.transform.ferc1.WideToTidy)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
`params.value_types`, such as the [core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204) table, this also
...
### *class* pudl.transform.ferc1.MergeXbrlMetadata(/, \*\*data: Any)
...
### pudl.transform.ferc1.merge_xbrl_metadata(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), xbrl_metadata: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), params: [MergeXbrlMetadata](#pudl.transform.ferc1.MergeXbrlMetadata)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Merge metadata based on params.

### *class* pudl.transform.ferc1.DropDuplicateRowsDbf(/, \*\*data: Any)
...
* **Parameters:**
  ...
  * **params** – an instance of [`DropDuplicateRowsDbf`](#pudl.transform.ferc1.DropDuplicateRowsDbf)
...
### *class* pudl.transform.ferc1.AlignRowNumbersDbf(/, \*\*data: Any)
...
### pudl.transform.ferc1.align_row_numbers_dbf(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), params: [AlignRowNumbersDbf](#pudl.transform.ferc1.AlignRowNumbersDbf)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Rename the xbrl_factoid column after [`align_row_numbers_dbf()`](#pudl.transform.ferc1.align_row_numbers_dbf).

### *class* pudl.transform.ferc1.SelectDbfRowsByCategory(/, \*\*data: Any)
...
### pudl.transform.ferc1.select_dbf_rows_by_category(processed_dbf: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), processed_xbrl: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), params: [SelectDbfRowsByCategory](#pudl.transform.ferc1.SelectDbfRowsByCategory)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
that was merged into the DBF data via [`align_row_numbers_dbf()`](#pudl.transform.ferc1.align_row_numbers_dbf) and was
converted into a column in the XBRL data via [`wide_to_tidy()`](#pudl.transform.ferc1.wide_to_tidy).
...
### *class* pudl.transform.ferc1.UnstackBalancesToReportYearInstantXbrl(/, \*\*data: Any)
...
Called in [`Ferc1AbstractTableTransformer.process_instant_xbrl()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.process_instant_xbrl).
...
`value_types` in [`wide_to_tidy()`](#pudl.transform.ferc1.wide_to_tidy) to normalize the table.
...
: primary_key_cols: The columns that should be used to check for duplicated data,
  : and also for unstacking the balance – these are set to be the index before
    ...
    [`Ferc1AbstractTableTransformer.source_table_primary_key()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.source_table_primary_key).

### *class* pudl.transform.ferc1.CombineAxisColumnsXbrl(/, \*\*data: Any)
...
#### *classmethod* doesnt_end_with_axis(v)

Ensure that new axis column ends in \_axis.

### pudl.transform.ferc1.combine_axis_columns_xbrl(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), params: [CombineAxisColumnsXbrl](#pudl.transform.ferc1.CombineAxisColumnsXbrl)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Combine axis columns from squished XBRL tables into one column with no NAs.

Called in [`Ferc1AbstractTableTransformer.process_xbrl()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.process_xbrl).
...
the function `extract_xbrl_concat()`. Once combined, we need to deal with their
axis columns.
...
### *class* pudl.transform.ferc1.AssignQuarterlyDataToYearlyDbf(/, \*\*data: Any)
...
the end of the year in `select_annual_rows_dbf()`. This ensures that
by this point, any quarterly data remaining in the input dataframe pertains
to the 4th quarter.

### *class* pudl.transform.ferc1.AddColumnWithUniformValue(/, \*\*data: Any)
...
### pudl.transform.ferc1.add_columns_with_uniform_values(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), params: [AddColumnsWithUniformValues](#pudl.transform.ferc1.AddColumnsWithUniformValues)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Add a column to a table with a single value.

### *class* pudl.transform.ferc1.IsCloseTolerance(/, \*\*data: Any)

Bases: [`pudl.transform.classes.TransformParams`](../classes/index.md#pudl.transform.classes.TransformParams)

Info for testing a particular check.

#### isclose_rtol *: Annotated[[float](https://docs.python.org/3/library/functions.html#float), [Field](../../metadata/classes/index.md#pudl.metadata.classes.Field)(ge=0.0)]* *= 1e-05*

Relative tolerance to use in `np.isclose()` for determining equality.

#### isclose_atol *: Annotated[[float](https://docs.python.org/3/library/functions.html#float), [Field](../../metadata/classes/index.md#pudl.metadata.classes.Field)(ge=0.0, le=0.01)]* *= 1e-08*

Absolute tolerance to use in `np.isclose()` for determining equality.

### *class* pudl.transform.ferc1.CalculationIsCloseTolerance(/, \*\*data: Any)

Bases: [`pudl.transform.classes.TransformParams`](../classes/index.md#pudl.transform.classes.TransformParams)

Calc params organized by check type.

#### error_frequency *: [IsCloseTolerance](#pudl.transform.ferc1.IsCloseTolerance)*

#### relative_error_magnitude *: [IsCloseTolerance](#pudl.transform.ferc1.IsCloseTolerance)*

#### null_calculated_value_frequency *: [IsCloseTolerance](#pudl.transform.ferc1.IsCloseTolerance)*

#### absolute_error_magnitude *: [IsCloseTolerance](#pudl.transform.ferc1.IsCloseTolerance)*

#### null_reported_value_frequency *: [IsCloseTolerance](#pudl.transform.ferc1.IsCloseTolerance)*

### *class* pudl.transform.ferc1.MetricTolerances(/, \*\*data: Any)

Bases: [`pudl.transform.classes.TransformParams`](../classes/index.md#pudl.transform.classes.TransformParams)

Tolerances for all data checks to be preformed within a grouped df.

#### error_frequency *: Annotated[[float](https://docs.python.org/3/library/functions.html#float), [Field](../../metadata/classes/index.md#pudl.metadata.classes.Field)(ge=0.0, le=1.0)]* *= 0.01*

#### relative_error_magnitude *: Annotated[[float](https://docs.python.org/3/library/functions.html#float), [Field](../../metadata/classes/index.md#pudl.metadata.classes.Field)(ge=0.0)]* *= 0.2*

#### null_calculated_value_frequency *: Annotated[[float](https://docs.python.org/3/library/functions.html#float), [Field](../../metadata/classes/index.md#pudl.metadata.classes.Field)(ge=0.0, le=1.0)]* *= 0.7*

Fraction of records with non-null reported values and null calculated values.

#### absolute_error_magnitude *: Annotated[[float](https://docs.python.org/3/library/functions.html#float), [Field](../../metadata/classes/index.md#pudl.metadata.classes.Field)(ge=0.0)]*

#### null_reported_value_frequency *: Annotated[[float](https://docs.python.org/3/library/functions.html#float), [Field](../../metadata/classes/index.md#pudl.metadata.classes.Field)(ge=0.0, le=1.0)]* *= 1.0*
...
#### ungrouped *: [MetricTolerances](#pudl.transform.ferc1.MetricTolerances)*

#### xbrl_factoid *: [MetricTolerances](#pudl.transform.ferc1.MetricTolerances)*

#### utility_id_ferc1 *: [MetricTolerances](#pudl.transform.ferc1.MetricTolerances)*

#### report_year *: [MetricTolerances](#pudl.transform.ferc1.MetricTolerances)*

#### table_name *: [MetricTolerances](#pudl.transform.ferc1.MetricTolerances)*

### *class* pudl.transform.ferc1.GroupMetricChecks(/, \*\*data: Any)
...
#### is_close_tolerance *: [CalculationIsCloseTolerance](#pudl.transform.ferc1.CalculationIsCloseTolerance)*

#### grouped_tol_ge_ungrouped_tol()

Grouped tolerance should always be greater than or equal to ungrouped.

### *class* pudl.transform.ferc1.ReconcileTableCalculations(/, \*\*data: Any)
...
#### group_metric_checks *: [GroupMetricChecks](#pudl.transform.ferc1.GroupMetricChecks)*
...
#### subdimension_merge_validation *: Literal['one_to_many', 'many_to_many']* *= 'one_to_many'*
...
don’t match within the tolerances of [`numpy.isclose()`](https://numpy.org/doc/stable/reference/generated/numpy.isclose.html#numpy.isclose) is below a set
threshold.
...
do not fail the [`numpy.isclose()`](https://numpy.org/doc/stable/reference/generated/numpy.isclose.html#numpy.isclose) test and so are not corrected.
...
* **Parameters:**
  ...
  * **params** – [`ReconcileTableCalculations`](#pudl.transform.ferc1.ReconcileTableCalculations) parameters.
* **Returns:**
...
### pudl.transform.ferc1.check_calculation_metrics_by_group(calculated_df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), group_metric_checks: [GroupMetricChecks](#pudl.transform.ferc1.GroupMetricChecks)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.ferc1.check_calculation_metrics(calculated_df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), group_metric_checks: [GroupMetricChecks](#pudl.transform.ferc1.GroupMetricChecks)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Run the calculation metrics and determine if calculations are within tolerance.

### *class* pudl.transform.ferc1.ErrorMetric(/, \*\*data: Any)
...
#### by *: Literal['ungrouped', 'table_name', 'xbrl_factoid', 'utility_id_ferc1', 'report_year']*
...
#### is_close_tolerance *: [IsCloseTolerance](#pudl.transform.ferc1.IsCloseTolerance)*
...
#### is_not_close(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)
...
#### apply_metric(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)
...
#### check(calculated_df) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Make a df w/ the metric, tolerance and is_error columns.

### *class* pudl.transform.ferc1.ErrorFrequency(/, \*\*data: Any)

Bases: [`ErrorMetric`](#pudl.transform.ferc1.ErrorMetric)
...
### *class* pudl.transform.ferc1.RelativeErrorMagnitude(/, \*\*data: Any)
...
### *class* pudl.transform.ferc1.AbsoluteErrorMagnitude(/, \*\*data: Any)
...
### *class* pudl.transform.ferc1.NullCalculatedValueFrequency(/, \*\*data: Any)
...
### *class* pudl.transform.ferc1.NullReportedValueFrequency(/, \*\*data: Any)
...
* **Parameters:**
  * **calculated_df** – DataFrame containing the data to correct. Must already have
    `abs_diff` column that was added by [`check_calculation_metrics()`](#pudl.transform.ferc1.check_calculation_metrics)
...
### *class* pudl.transform.ferc1.Ferc1TableTransformParams(/, \*\*data: Any)

Bases: [`pudl.transform.classes.TableTransformParams`](../classes/index.md#pudl.transform.classes.TableTransformParams)
...
[`pudl.transform.classes.AbstractTableTransformer`](../classes/index.md#pudl.transform.classes.AbstractTableTransformer) class.

#### rename_columns_ferc1 *: [RenameColumnsFerc1](#pudl.transform.ferc1.RenameColumnsFerc1)*

#### wide_to_tidy *: [WideToTidySourceFerc1](#pudl.transform.ferc1.WideToTidySourceFerc1)*

#### merge_xbrl_metadata *: [MergeXbrlMetadata](#pudl.transform.ferc1.MergeXbrlMetadata)*

#### align_row_numbers_dbf *: [AlignRowNumbersDbf](#pudl.transform.ferc1.AlignRowNumbersDbf)*

#### drop_duplicate_rows_dbf *: [DropDuplicateRowsDbf](#pudl.transform.ferc1.DropDuplicateRowsDbf)*

#### assign_quarterly_data_to_yearly_dbf *: [AssignQuarterlyDataToYearlyDbf](#pudl.transform.ferc1.AssignQuarterlyDataToYearlyDbf)*

#### select_dbf_rows_by_category *: [SelectDbfRowsByCategory](#pudl.transform.ferc1.SelectDbfRowsByCategory)*

#### unstack_balances_to_report_year_instant_xbrl *: [UnstackBalancesToReportYearInstantXbrl](#pudl.transform.ferc1.UnstackBalancesToReportYearInstantXbrl)*

#### combine_axis_columns_xbrl *: [CombineAxisColumnsXbrl](#pudl.transform.ferc1.CombineAxisColumnsXbrl)*

#### reconcile_table_calculations *: [ReconcileTableCalculations](#pudl.transform.ferc1.ReconcileTableCalculations)*
...
### pudl.transform.ferc1.get_ferc1_dbf_rows_to_map(ferc1_engine: sqlalchemy.Engine) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.ferc1.update_dbf_to_xbrl_map(ferc1_engine: sqlalchemy.Engine) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### table_id *: [TableIdFerc1](#pudl.transform.ferc1.TableIdFerc1)*
...
`TableTransformParams` class, if it has been defined.

#### params *: [Ferc1AbstractTableTransformer.parameter_model](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.parameter_model)*
...
#### xbrl_metadata *: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)*
...
#### transform_end(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
happens in [`Ferc1AbstractTableTransformer.merge_xbrl_metadata()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.merge_xbrl_metadata).

#### process_xbrl_metadata(xbrl_metadata_converted: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), xbrl_calculations: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
* **Parameters:**
  ...
  * **xbrl_calculations** – Dataframe of calculation components. Result of
    [`process_xbrl_metadata_calculations()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.process_xbrl_metadata_calculations).

#### deduplicate_xbrl_factoid_xbrl_metadata(tbl_meta: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
columns:
\* [`RenameColumnsFerc1`](#pudl.transform.ferc1.RenameColumnsFerc1)
\* [`WideToTidySourceFerc1`](#pudl.transform.ferc1.WideToTidySourceFerc1)
\* [`UnstackBalancesToReportYearInstantXbrl`](#pudl.transform.ferc1.UnstackBalancesToReportYearInstantXbrl)
\* `ConvertUnits`
...
#### rename_xbrl_factoid(col: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)

Rename a series of raw to PUDL factoid names via [`raw_xbrl_factoid_to_pudl_name()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.raw_xbrl_factoid_to_pudl_name).

#### rename_xbrl_factoid_other_tables(calc_comps)
...
#### add_metadata_corrections(tbl_meta: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### add_calculation_corrections(calc_components: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### get_xbrl_calculation_fixes() → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Grab the XBRL calculations fixes for this table.

#### apply_xbrl_calculation_fixes(calc_components: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), calc_fixes: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### process_xbrl_metadata_calculations(xbrl_metadata_converted: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[`apply_xbrl_calculation_fixes()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.apply_xbrl_calculation_fixes), adds corrections records via
[`add_calculation_corrections()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.add_calculation_corrections) and adds the column
...
#### process_dbf(raw_dbf: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

DBF-specific transformations that take place before concatenation.

#### process_xbrl(raw_xbrl_instant: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), raw_xbrl_duration: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

XBRL-specific transformations that take place before concatenation.

#### rename_columns(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), rename_stage: Literal['dbf', 'xbrl', 'xbrl_instant', 'xbrl_duration'] | [None](https://docs.python.org/3/library/constants.html#None) = None, params: [pudl.transform.classes.RenameColumns](../classes/index.md#pudl.transform.classes.RenameColumns) | [None](https://docs.python.org/3/library/constants.html#None) = None)
...
#### merge_instant_and_duration_tables_xbrl(raw_xbrl_instant: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), raw_xbrl_duration: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### process_instant_xbrl(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### process_duration_xbrl(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### drop_footnote_columns_dbf(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### drop_unused_original_columns_dbf(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Remove residual DBF specific columns.

#### assign_record_id(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), source_ferc1: [SourceFerc1](#pudl.transform.ferc1.SourceFerc1)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
Transformer class for the [core_ferc1_\_yearly_identification_certification](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-identification-certification) table.
...
A table transformer specific to the [core_ferc1_\_yearly_steam_plants_fuel_sched402](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-steam-plants-fuel-sched402) table.

The [core_ferc1_\_yearly_steam_plants_fuel_sched402](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-steam-plants-fuel-sched402) table reports data about fuel consumed by large thermal power
plants in the [core_ferc1_\_yearly_steam_plants_sched402](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-steam-plants-sched402) table. Each record in the steam table is
...
Table specific transforms for core_ferc1_\_yearly_steam_plants_fuel_sched402.
...
Special pre-concat treatment of the [core_ferc1_\_yearly_steam_plants_fuel_sched402](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-steam-plants-fuel-sched402) table.
...
#### to_numeric(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Convert columns containing numeric strings to numeric types.

#### standardize_physical_fuel_units(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[https://world-nuclear.org/information-library/facts-and-figures/heat-values-of-various-fuels.aspx](https://world-nuclear.org/information-library/facts-and-figures/heat-values-of-various-fuels.aspx)

#### aggregate_duplicate_fuel_types_xbrl(fuel_xbrl: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Aggregate the fuel records having duplicate primary keys.

#### drop_total_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
In the case of the core_ferc1_\_yearly_steam_plants_fuel_sched402 table, we drop any row where all the data columns
...
#### drop_invalid_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), params: [pudl.transform.classes.InvalidRows](../classes/index.md#pudl.transform.classes.InvalidRows) | [None](https://docs.python.org/3/library/constants.html#None) = None) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
Transformer class for the [core_ferc1_\_yearly_steam_plants_sched402](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-steam-plants-sched402) table.
...
A table transformer specific to the [core_ferc1_\_yearly_hydroelectric_plants_sched406](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-hydroelectric-plants-sched406) table.
...
Transformer class for [core_ferc1_\_yearly_pumped_storage_plants_sched408](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-pumped-storage-plants-sched408) table.
...
Transformer class for [core_ferc1_\_yearly_purchased_power_and_exchanges_sched326](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-purchased-power-and-exchanges-sched326).
...
A transformer for the [core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204) table.
...
`pd.Series.replace()` instead of `pd.DataFrame.rename()`.
...
#### apply_sign_conventions(df) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### targeted_drop_duplicates_dbf(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
A table transformer specific to the [core_ferc1_\_yearly_small_plants_sched410](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-small-plants-sched410) table.
...
Table specific transforms for core_ferc1_\_yearly_small_plants_sched410.
...
#### remove_messy_plant_name_duplicates(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### extract_ferc1_license(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### \_find_possible_header_or_note_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Find and label rows that might be headers or notes.

Called by the coordinating function [`label_row_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.label_row_types).
...
as True will be further scrutinized in the [`_label_header_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_header_rows) and
[`_label_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows) functions to determine whether they are actually
headers or notes.
...
Once the [`_find_possible_header_or_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._find_possible_header_or_note_rows) function identifies rows
that are either headers or notes, we must determine which one they are. As
described in the [`_label_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows) function, notes rows are usually
...
[`_label_note_rows_group()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows_group) function.
...
: group: A utility-year grouping of the concatenated FERC XBRL and DBF tables.
  : This table must have been run through the
    [`_find_possible_header_or_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._find_possible_header_or_note_rows) function and contain the
...
#### \_label_header_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[`_find_possible_header_or_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._find_possible_header_or_note_rows) function, this function sorts out
...
[`_label_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows) so that the bad header values get overridden by the
`note` designation.

Params:
: df: Pre-processed, concatenated XBRL and DBF data that has been run through
  the [`_find_possible_header_or_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._find_possible_header_or_note_rows) function and contains the
  column `possible_header_or_note`.
...
Called within the wrapper function [`_label_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows)
...
#### \_label_note_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Wrapper for [`_label_note_rows_group()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows_group).
...
[`label_row_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.label_row_types) for more detail. This function labels note rows.
...
methodology defined in [`_label_note_rows_group()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows_group) to each group.
...
#### \_label_total_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
Similar to [`_label_header_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_header_rows), it’s important that this be called before
[`_label_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows) in [`label_row_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.label_row_types) so that not clumps can
...
#### label_row_types(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
| keuka (c)          | NA           | 80            |
| total plants       | NA           | 310           |
| 1. project #2738   | NA           | NA            |
| 1. project #2835   | NA           | NA            |
| 1. project #2852   | NA           | NA            |
...
Coordinates [`_label_header_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_header_rows), [`_label_total_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_total_rows),
[`_label_note_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_note_rows).
...
#### prep_header_fuel_and_plant_types(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), show_unmapped_headers=False) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Forward fill header rows to prep for fuel and plant type extraction.

The headers we’ve identified in [`_label_header_rows()`](#pudl.transform.ferc1.SmallPlantsTableTransformer._label_header_rows) can be used to
...
`plant_type_from_header`. In [`map_header_fuel_and_plant_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.map_header_fuel_and_plant_types), these
...
and must be cleaned via [`pudl.transform.classes.categorize_strings()`](../classes/index.md#pudl.transform.classes.categorize_strings) in
order for us to know which are truly `pd.NA` or `other`. Because we also
use [`pudl.transform.classes.categorize_strings()`](../classes/index.md#pudl.transform.classes.categorize_strings) to map the headers to fuel
...
| plant_name_ferc1   | plant<br/>\_type   | fuel<br/>\_type   | plant_type<br/>\_from_header   | fuel_type<br/>\_from_header   |
|--------------------|--------------------|-------------------|--------------------------------|-------------------------------|
...
Params:
: df: Pre-processed, concatenated XBRL and DBF data that has been run through
  `_label_row_type()` and contains the columns `row_type`.
...
#### map_header_fuel_and_plant_types(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Fill `pd.NA` and `other` plant and fuel types with cleaned headers.

[`prep_header_fuel_and_plant_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.prep_header_fuel_and_plant_types) extracted and forward filled the header
values; `pudl.transform.params.categorize_strings()` cleaned them according
...
[`prep_header_fuel_and_plant_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.prep_header_fuel_and_plant_types).

Params:
: df: Pre-processed, concatenated XBRL and DBF data that has been run through
  [`prep_header_fuel_and_plant_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.prep_header_fuel_and_plant_types) and contains the columns
...
#### map_plant_name_fuel_types(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### associate_notes_with_values(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
| 1. project #2738   | note       | 2738               |
| 1. project #2835   | note       | 2738               |
| 1. project #2852   | note       | 2738               |
...
|--------------------|------------|------------------|--------------------|
| HYDRO:             | header     | NA               | NA                 |
| rainbow falls (b)  | NA         | 1. project #2835 | 2835               |
| cadyville (a)      | NA         | 1. project #2738 | 2738               |
| keuka (c)          | NA         | 1. project #2852 | 2752               |
| total plants       | total      | NA               | NA                 |
| 1. project #2738   | note       | NA               | 2738               |
| 1. project #2835   | note       | NA               | 2835               |
| 1. project #2852   | note       | NA               | 2752               |
...
Params:
: df: Pre-processed, concatenated XBRL and DBF data that has been run through
  [`label_row_types()`](#pudl.transform.ferc1.SmallPlantsTableTransformer.label_row_types) and contains the column `row_type`.
...
#### spot_fix_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
A table transformer for the [core_ferc1_\_yearly_transmission_lines_sched422](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-transmission-lines-sched422) table.
...
Transformer class for [core_ferc1_\_yearly_energy_sources_sched401](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-energy-sources-sched401) table.
...
Transformer class for [core_ferc1_\_yearly_energy_dispositions_sched401](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-energy-dispositions-sched401) table.
...
Transformer class for [core_ferc1_\_yearly_utility_plant_summary_sched200](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-utility-plant-summary-sched200) table.
...
[`aggregated_xbrl_factoids()`](#pudl.transform.ferc1.UtilityPlantSummaryTableTransformer.aggregated_xbrl_factoids).

#### transform_main(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Default transforming, plus spot fixing and building aggregate xbrl_factoid.

#### aggregated_xbrl_factoids(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Aggregate xbrl_factoids records for linking to [core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204).

This table has two `xbrl_factoid` which can be linked via calculations to one
`xbrl_factoid` in the [core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204).
Doing this 2:1 linkage would be fine in theory. But the
[core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204) is in most senses
...
manner between this table and the [core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204).

We’ll also add this factoid into the metadata via `process_xbrl_metadata()`
and add the linking calculation via `apply_xbrl_calculation_fixes()`.

#### spot_fix_bad_signs(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
Transformer class for [core_ferc1_\_yearly_balance_sheet_liabilities_sched110](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-balance-sheet-liabilities-sched110) table.
...
Transformer class for [core_ferc1_\_yearly_balance_sheet_assets_sched110](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-balance-sheet-assets-sched110) table.
...
Transformer class for the [core_ferc1_\_yearly_income_statements_sched114](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-income-statements-sched114) table.
...
for the whole table? See: [https://github.com/catalyst-cooperative/pudl/issues/471](https://github.com/catalyst-cooperative/pudl/issues/471)
...
Transformer class for [core_ferc1_\_yearly_retained_earnings_sched118](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-retained-earnings-sched118) table.
...
Preform generic [`process_dbf()`](#pudl.transform.ferc1.RetainedEarningsTableTransformer.process_dbf), plus deal with duplicates.

Along with the standard processing in
[`Ferc1AbstractTableTransformer.process_dbf()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.process_dbf), this method runs:
\* [`targeted_drop_duplicates_dbf()`](#pudl.transform.ferc1.RetainedEarningsTableTransformer.targeted_drop_duplicates_dbf)
\* [`reconcile_double_year_earnings_types_dbf()`](#pudl.transform.ferc1.RetainedEarningsTableTransformer.reconcile_double_year_earnings_types_dbf)
...
#### check_double_year_earnings_types(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### reconcile_double_year_earnings_types_dbf(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### add_previous_year_factoid(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### deduplicate_xbrl_factoid_xbrl_metadata(tbl_meta) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
calculations and ferc account #’s), for every single [`wide_to_tidy()`](#pudl.transform.ferc1.wide_to_tidy) value
column.

Note: This is **almost** the same as the method for
[core_ferc1_\_yearly_operating_revenues_sched300](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-operating-revenues-sched300). If we wanted to lean into this
...
Transformer class for [core_ferc1_\_yearly_depreciation_summary_sched336](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-summary-sched336) table.
...
Transformer class for [core_ferc1_\_yearly_depreciation_factors_sched336](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-factors-sched336) table.
...
Transformer class for [core_ferc1_\_yearly_depreciation_changes_sched219](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-changes-sched219) table.
...
#### convert_xbrl_metadata_json_to_df(xbrl_metadata_json) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
#### process_dbf(raw_df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
Transformer for [core_ferc1_\_yearly_depreciation_by_function_sched219](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-by-function-sched219) table.
...
[`convert_xbrl_metadata_json_to_df()`](#pudl.transform.ferc1.DepreciationByFunctionTableTransformer.convert_xbrl_metadata_json_to_df), this method creates a metadata table
...
[`transform_main()`](#pudl.transform.ferc1.DepreciationByFunctionTableTransformer.transform_main). Because this table only has one value for its
...
Add `depreciation_type` then run default [`transform_main()`](#pudl.transform.ferc1.DepreciationByFunctionTableTransformer.transform_main).
...
Run standard [`Ferc1AbstractTableTransformer.transform_end()`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer.transform_end) plus a data validation step.

In [`infer_intra_factoid_totals()`](#pudl.transform.ferc1.infer_intra_factoid_totals), we restrict the child calculation
...
loss in [`pudl.output.ferc1.Exploder`](../../output/ferc1/index.md#pudl.output.ferc1.Exploder).

### *class* pudl.transform.ferc1.OperatingExpensesTableTransformer(xbrl_metadata_json: [dict](https://docs.python.org/3/library/stdtypes.html#dict)[Literal['instant', 'duration'], [list](https://docs.python.org/3/library/stdtypes.html#list)[[dict](https://docs.python.org/3/library/stdtypes.html#dict)[[str](https://docs.python.org/3/library/stdtypes.html#str), Any]]] | [None](https://docs.python.org/3/library/constants.html#None) = None, params: [pudl.transform.classes.TableTransformParams](../classes/index.md#pudl.transform.classes.TableTransformParams) | [None](https://docs.python.org/3/library/constants.html#None) = None, cache_dfs: [bool](https://docs.python.org/3/library/functions.html#bool) = False, clear_cached_dfs: [bool](https://docs.python.org/3/library/functions.html#bool) = True, pudl_paths: [pudl.workspace.setup.PudlPaths](../../workspace/setup/index.md#pudl.workspace.setup.PudlPaths) | [None](https://docs.python.org/3/library/constants.html#None) = None)

Bases: [`Ferc1AbstractTableTransformer`](#pudl.transform.ferc1.Ferc1AbstractTableTransformer)

Transformer class for [core_ferc1_\_yearly_operating_expenses_sched320](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-operating-expenses-sched320) table.
...
#### targeted_drop_duplicates_dbf(raw_df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
Transformer class for [core_ferc1_\_yearly_operating_revenues_sched300](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-operating-revenues-sched300) table.
...
the basis of the `xbrl_factoid`. This table used [`wide_to_tidy()`](#pudl.transform.ferc1.wide_to_tidy) with three
...
Transform class for [core_ferc1_\_yearly_cash_flows_sched120](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-cash-flows-sched120) table.
...
Note: This step could be avoided if we employed a `drop_invalid_rows()`
transform step with `required_valid_cols = ["amount"]`

#### validate_start_end_balance(df)
...
Transform class for [core_ferc1_\_yearly_sales_by_rate_schedules_sched304](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-sales-by-rate-schedules-sched304) table.
...
#### add_axis_to_total_table_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame))
...
Transformer class for [core_ferc1_\_yearly_other_regulatory_liabilities_sched278](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-other-regulatory-liabilities-sched278) table.
...
Transformer class for [core_ferc1_\_yearly_other_regulatory_assets_sched232](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-other-regulatory-assets-sched232) table.
...
### pudl.transform.ferc1.remove_rare_utility_type_subdimensions_rows(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[`_core_ferc1__table_dimensions()`](#pudl.transform.ferc1._core_ferc1__table_dimensions) because that is what we use to build the
calculation components table.

### pudl.transform.ferc1.\_core_ferc1_\_table_dimensions(\*\*kwargs) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[core_ferc1_\_yearly_depreciation_by_function_sched219](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-depreciation-by-function-sched219) table,
...
contain the `xbrl_factoid` using [`table_to_xbrl_factoid_name()`](#pudl.transform.ferc1.table_to_xbrl_factoid_name) rename
...
other dimension columns found in [`other_dimensions()`](#pudl.transform.ferc1.other_dimensions).

### pudl.transform.ferc1.\_core_ferc1_xbrl_\_metadata(\*\*kwargs) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Build a table of all of the tables’ XBRL metadata.

### pudl.transform.ferc1.\_core_ferc1_xbrl_\_calculation_components(\*\*kwargs) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[core_ferc1_\_yearly_utility_plant_summary_sched200](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-utility-plant-summary-sched200) table contains records with a variety of
...
detail can be found in the [core_ferc1_\_yearly_plant_in_service_sched204](../../../../data_dictionaries/pudl_db.md#core-ferc1-yearly-plant-in-service-sched204) table.
...
[`_core_ferc1__table_dimensions()`](#pudl.transform.ferc1._core_ferc1__table_dimensions) to fill in missing (previously implied) dimension
...
* **Parameters:**
  ...
  * **table_dimensions_ferc1** – table with all observed values of
    [`other_dimensions()`](#pudl.transform.ferc1.other_dimensions) for each `table_name` and `xbrl_factoid`
...
* **Parameters:**
  ...
  * **table_dimensions** – table with all observed values of [`other_dimensions()`](#pudl.transform.ferc1.other_dimensions) for
...
### pudl.transform.ferc1.add_calculation_component_corrections(calc_components: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.ferc1.\_core_ferc1_\_calculation_metric_checks(\*\*kwargs)
