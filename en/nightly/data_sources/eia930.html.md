...
| Source URL                      | [https://www.eia.gov/electricity/gridmonitor/](https://www.eia.gov/electricity/gridmonitor/)                                                                                                                                                                                                                                                            |
|---------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Source Description              | The EIA Form 930 provides hourly demand and generation statistics by balancing area (or sub-balancing area in the case of some larger areas). These statistics include a breakdown by energy source (coal, gas, hydro, wind, solar, etc.) as well as interchange between the balancing areas, including international exchanges with Canada and Mexico. |
| Respondents                     | All entities in the contiguous United States that are listed in the North American Electric Reliability Corporation’s (NERC) Compliance Registry as a balancing authority.                                                                                                                                                                              |
| Source Format                   | Comma separated values (CSV)                                                                                                                                                                                                                                                                                                                            |
| Download Size                   | 413 MB                                                                                                                                                                                                                                                                                                                                                  |
| Temporal Coverage               | 2015half2-2026half2                                                                                                                                                                                                                                                                                                                                     |
| PUDL Code                       | `eia930`                                                                                                                                                                                                                                                                                                                                                |
| Unprocessed Source Data Archive | [10.5281/zenodo.10840077](https://doi.org/10.5281/zenodo.10840077)                                                                                                                                                                                                                                                                                      |
| Issues                          | [Open EIA Form 930 – Hourly and Daily Balancing Authority Operations Report issues](https://github.com/catalyst-cooperative/pudl/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+label%3Aeia930)                                                                                                                                                           |
...
downloaded directly from [Cloud Storage](../data_access.html.md#access-cloud) via the links embedded in the
[PUDL Data Dictionary](../data_dictionaries/pudl_db.html.md) or accessed on [Kaggle](../data_access.html.md#access-kaggle).

| Data Dictionary                                                                                                                                        | Browse Online                                                                                                                                                                               |
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [core_eia930_\_hourly_interchange](../data_dictionaries/pudl_db.html.md#core-eia930-hourly-interchange)                                         | [https://data.catalyst.coop/preview/pudl/core_eia930_\_hourly_interchange](https://data.catalyst.coop/preview/pudl/core_eia930__hourly_interchange)                                         |
| [core_eia930_\_hourly_net_generation_by_energy_source](../data_dictionaries/pudl_db.html.md#core-eia930-hourly-net-generation-by-energy-source) | [https://data.catalyst.coop/preview/pudl/core_eia930_\_hourly_net_generation_by_energy_source](https://data.catalyst.coop/preview/pudl/core_eia930__hourly_net_generation_by_energy_source) |
| [core_eia930_\_hourly_operations](../data_dictionaries/pudl_db.html.md#core-eia930-hourly-operations)                                           | [https://data.catalyst.coop/preview/pudl/core_eia930_\_hourly_operations](https://data.catalyst.coop/preview/pudl/core_eia930__hourly_operations)                                           |
| [core_eia930_\_hourly_subregion_demand](../data_dictionaries/pudl_db.html.md#core-eia930-hourly-subregion-demand)                               | [https://data.catalyst.coop/preview/pudl/core_eia930_\_hourly_subregion_demand](https://data.catalyst.coop/preview/pudl/core_eia930__hourly_subregion_demand)                               |
| [out_eia930_\_hourly_aggregated_demand](../data_dictionaries/pudl_db.html.md#out-eia930-hourly-aggregated-demand)                               | [https://data.catalyst.coop/preview/pudl/out_eia930_\_hourly_aggregated_demand](https://data.catalyst.coop/preview/pudl/out_eia930__hourly_aggregated_demand)                               |
| [out_eia930_\_hourly_operations](../data_dictionaries/pudl_db.html.md#out-eia930-hourly-operations)                                             | [https://data.catalyst.coop/preview/pudl/out_eia930_\_hourly_operations](https://data.catalyst.coop/preview/pudl/out_eia930__hourly_operations)                                             |
| [out_eia930_\_hourly_subregion_demand](../data_dictionaries/pudl_db.html.md#out-eia930-hourly-subregion-demand)                                 | [https://data.catalyst.coop/preview/pudl/out_eia930_\_hourly_subregion_demand](https://data.catalyst.coop/preview/pudl/out_eia930__hourly_subregion_demand)                                 |

## Background

The EIA Form 930 provides hourly operating data about the high-voltage bulk electric
power grid in the Lower 48 states. See the [official EIA-930 documentation](https://www.eia.gov/electricity/gridmonitor/about) for additional details.
...
can be found in [core_eia_\_codes_balancing_authority_subregions](../data_dictionaries/pudl_db.html.md#core-eia-codes-balancing-authority-subregions)
...
* [`Eia930 Instructions 2026-07-31 (PDF)`](_downloads/2297feef7fae5877a95f4a67bdc3cab2/eia930_instructions_2026-07-31.pdf)
* [`Eia930 Instructions 2029-07-31 (PDF)`](_downloads/b8fe31e51b528d33a75b75308ea9cca1/eia930_instructions_2029-07-31.pdf)
...
Electric Reliability Corporation](https://www.nerc.com) (NERC), and are mainly
...
Be sure to check out [the official EIA-930 documentation](https://www.eia.gov/electricity/gridmonitor/about).
...
see [Timeseries Imputation](../methodology/timeseries_imputation.html.md)

For a visual exploration of the imputed values and comparison with other imputations,
check out the following notebooks on Kaggle:
...
<a id="data-sources-eia930-changes-in-energy-source-granularity-over-time"></a>
...
| Removed in Q1 2025 release   | Added in Q1 2025 release                                                                           |
|------------------------------|----------------------------------------------------------------------------------------------------|
|                              | `battery_storage`                                                                                  |
|                              | `geothermal`                                                                                       |
| `hydro`                      | `hydro_excluding_pumped_storage`<br/><br/><br/>`pumped_storage`<br/><br/>                          |
|                              | `other_energy_storage`                                                                             |
| `solar`                      | `solar_w_integrated_battery_storage`<br/><br/><br/>`solar_wo_integrated_battery_storage`<br/><br/> |
|                              | `unknown_energy_storage`                                                                           |
| `wind`                       | `wind_w_integrated_battery_storage`<br/><br/><br/>`wind_wo_integrated_battery_storage`<br/><br/>   |
...
BA can be found in the [core_eia_\_codes_balancing_authorities](../data_dictionaries/pudl_db.html.md#core-eia-codes-balancing-authorities) table, and can be
used to re-localize the UTC timestamps if needed.

### Inconsistent totals

See PR [#3584](https://github.com/catalyst-cooperative/pudl/pull/3584) and [this comment](https://github.com/catalyst-cooperative/pudl/pull/3584#issuecomment-2080346566)
...
* [core_eia_\_codes_balancing_authorities](../data_dictionaries/pudl_db.html.md#core-eia-codes-balancing-authorities)
* [core_eia_\_codes_balancing_authority_subregions](../data_dictionaries/pudl_db.html.md#core-eia-codes-balancing-authority-subregions)
...
* See the [Grid Emissions project](https://github.com/jdechalendar/gridemissions/)
  from [@jdechalendar](https://github.com/sponsors/jdechalendar) at Stanford for one example of managing irregularities in
  the reported data, and the related paper [A Physics-informed data reconciliation
  framework for real-time electricity and emissions tracking](https://arxiv.org/abs/2103.05663) for a method of reconciling the reported data
  with physical constraints.
* The [Open Grid Emissions Initiative](https://github.com/singularity-energy/open-grid-emissions)
  from [@grgmiller](https://github.com/sponsors/grgmiller) at [Singularity Energy](https://singularity.energy) builds
  on the above method. See the [OGE Documentation](https://docs.singularity.energy/docs/open-grid-emissions/about_ogei-about-the-open-grid-emissions-initiative).

## PUDL Data Transformations

To see the transformations applied to the data in each table, you can read the
docstrings for [`pudl.transform.eia930`](../autoapi/pudl/transform/eia930/index.html.md#module-pudl.transform.eia930) created for each table’s
