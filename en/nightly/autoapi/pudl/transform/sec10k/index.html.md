...
### pudl.transform.sec10k.\_year_quarter_to_date(year_quarter: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)

Convert a year quarter in the format ‘2024q1’ to date type.

### pudl.transform.sec10k.\_simplify_filename_sec10k(filename_sec10k: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)
...
[https://www.sec.gov/Archives/edgar/data/](https://www.sec.gov/Archives/edgar/data/) and adding back the “.txt” file type
extension, as is done for the source_url column in the output tables.

### pudl.transform.sec10k.\_extract_filer_cik_from_filename(filename_col: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)

Extract filer company’s central index key from the first token of filename.

### pudl.transform.sec10k.\_compute_fraction_owned(percent_ownership: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)

Clean percent ownership, convert to float, then convert percent to ratio.

### pudl.transform.sec10k.\_standardize_taxpayer_id_irs(taxpayer_id_irs: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)
...
### pudl.transform.sec10k.\_standardize_industrial_classification(sic: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.sec10k.\_standardize_company_name(col: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)
...
### pudl.transform.sec10k.\_remove_bad_subsidiary_names(col: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)
...
### pudl.transform.sec10k.\_standardize_location(loc_col: [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)) → [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)

Map two letter state codes to full names using EDGAR state and country code mapping.

### pudl.transform.sec10k.\_match_ex21_subsidiaries_to_filer_company(filer_info_df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), ownership_df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.sec10k.core_sec10k_\_quarterly_filings(raw_sec10k_\_quarterly_filings: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Standardize the contents of the SEC 10-K filings table.

### pudl.transform.sec10k.core_sec10k_\_company_info(raw_sec10k_\_quarterly_company_information: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame))
...
### pudl.transform.sec10k.core_sec10k_\_quarterly_company_information(\_core_sec10k_\_quarterly_company_information: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Clean and standardize the contents of the SEC 10-K company information table.

### pudl.transform.sec10k.core_sec10k_\_changelog_company_name(\_core_sec10k_\_changelog_company_name: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.sec10k.core_sec10k_\_quarterly_exhibit_21_company_ownership(raw_sec10k_\_exhibit_21_company_ownership: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Standardize the contents of the SEC 10-K exhibit 21 company ownership table.

### pudl.transform.sec10k.core_sec10k_\_assn_sec10k_filers_and_eia_utilities(raw_sec10k_\_parents_and_subsidiaries: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.sec10k.core_sec10k_\_assn_exhibit_21_subsidiaries_and_filers(core_sec10k_\_quarterly_filings, core_sec10k_\_quarterly_company_information, core_sec10k_\_quarterly_exhibit_21_company_ownership) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.transform.sec10k.core_sec10k_\_assn_exhibit_21_subsidiaries_and_eia_utilities(core_sec10k_\_assn_sec10k_filers_and_eia_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_eia_\_entity_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_sec10k_\_quarterly_exhibit_21_company_ownership: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_sec10k_\_assn_exhibit_21_subsidiaries_and_filers: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
