...
offenders `self.off_by_facts`. This method identifies data corrections
for those `self.off_by_facts` and adds them into the exploded data table.
...
subcomponents (via [`pudl.transform.ferc1.calculate_values_from_components()`](../../transform/ferc1/index.md#pudl.transform.ferc1.calculate_values_from_components))
