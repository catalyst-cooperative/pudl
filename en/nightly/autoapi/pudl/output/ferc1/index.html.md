...
* **Returns:**
  The asset description portion of the asset name.
* **Return type:**
  asset_description
...
### pudl.output.ferc1.\_out_ferc1_\_yearly_plants_utilities(core_pudl_\_assn_ferc1_pudl_plants: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_pudl_\_assn_ferc1_pudl_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_pudl_\_assn_ferc1_dbf_pudl_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_pudl_\_assn_ferc1_xbrl_pudl_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

A denormalized table containing FERC plant and utility names and IDs.

### pudl.output.ferc1.out_ferc1_\_yearly_steam_plants_sched402(\_out_ferc1_\_yearly_plants_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), \_out_ferc1_\_yearly_steam_plants_sched402_with_plant_ids: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
* **Parameters:**
  * **\_out_ferc1_\_yearly_plants_utilities** – Denormalized dataframe of FERC Form 1
    plants and utilities data.
  * **\_out_ferc1_\_yearly_steam_plants_sched402_with_plant_ids** – The FERC Form 1 steam
...
### pudl.output.ferc1.out_ferc1_\_yearly_small_plants_sched410(core_ferc1_\_yearly_small_plants_sched410: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), \_out_ferc1_\_yearly_plants_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Pull a useful dataframe related to the FERC Form 1 small plants.

### pudl.output.ferc1.out_ferc1_\_yearly_hydroelectric_plants_sched406(core_ferc1_\_yearly_hydroelectric_plants_sched406: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), \_out_ferc1_\_yearly_plants_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Pull a useful dataframe related to the FERC Form 1 hydro plants.

### pudl.output.ferc1.out_ferc1_\_yearly_pumped_storage_plants_sched408(core_ferc1_\_yearly_pumped_storage_plants_sched408: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), \_out_ferc1_\_yearly_plants_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Pull a dataframe of FERC Form 1 Pumped Storage plant data.

### pudl.output.ferc1.out_ferc1_\_yearly_steam_plants_fuel_sched402(core_ferc1_\_yearly_steam_plants_fuel_sched402: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), \_out_ferc1_\_yearly_plants_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.output.ferc1.out_ferc1_\_yearly_all_plants(out_ferc1_\_yearly_steam_plants_sched402: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), out_ferc1_\_yearly_small_plants_sched410: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), out_ferc1_\_yearly_hydroelectric_plants_sched406: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), out_ferc1_\_yearly_pumped_storage_plants_sched408: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### pudl.output.ferc1.out_ferc1_\_yearly_steam_plants_fuel_by_plant_sched402(context, core_ferc1_\_yearly_steam_plants_fuel_sched402: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), \_out_ferc1_\_yearly_plants_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
* **Parameters:**
  ...
  * **core_ferc1_\_yearly_steam_plants_fuel_sched402** – Normalized FERC fuel table.
  * **\_out_ferc1_\_yearly_plants_utilities** – Denormalized table of FERC1 plant & utility
    IDs.
* **Returns:**
...
### pudl.output.ferc1.add_mean_cap_additions(steam_df)

Add mean capital additions over lifetime of plant.

### *class* pudl.output.ferc1.NodeId

Bases: `NamedTuple`

The primary keys which identify a node in a calculation tree.

Since NodeId is just a `NamedTuple` a list of NodeId instances can also be
used to index into a :class:pandas.DataFrame\` that uses these fields as its index.
This is convenient since many `networkx` functions and methods return iterable
...
* **Returns:**
  A list of `AssetsDefinitions` where each asset is an exploded FERC Form 1
  table.
...
#### add_sizable_minority_corrections_to_calcs(exploded_calcs: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Add correction calculation records for the sizable fuck up utilities.

#### *property* exploded_meta *: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)*

Combine a set of interrelated tables’ metadata for use in [`Exploder`](#pudl.output.ferc1.Exploder).
...
#### *property* calculation_forest *: [XbrlCalculationForestFerc1](#pudl.output.ferc1.XbrlCalculationForestFerc1)*
...
1. Prep all of the individual tables for explosion (via [`prep_table_to_explode()`](#pudl.output.ferc1.Exploder.prep_table_to_explode)).
2. Concatenate all of the tables together (via [`initial_explosion_concatenation()`](#pudl.output.ferc1.Exploder.initial_explosion_concatenation)).
3. Manage specific calculated values when a sizable minority of utilities report in a
   non-standard way (via [`add_sizable_minority_corrections()`](#pudl.output.ferc1.Exploder.add_sizable_minority_corrections)).
4. Reconcile the inter-table calculations (via [`reconcile_intertable_calculations()`](#pudl.output.ferc1.Exploder.reconcile_intertable_calculations))
5. Annotate the data with additional metadata (via:meth:XbrlCalculationForestFerc1.annotated_forest).
6. Identify the most granular `xbrl_factoids` (via
   [`XbrlCalculationForestFerc1.leafy_meta()`](#pudl.output.ferc1.XbrlCalculationForestFerc1.leafy_meta)).
7. Reconcile a calculation of least granular records using the most granular
...
#### calculate_intertable_non_total_calculations(exploded: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Calculate the inter-table non-total calculable xbrl_factoids.

#### add_sizable_minority_corrections(calculated_df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
calculated values with a different set of child subcomponents. Our tooling for
these calculation expects all utilities to report in the same manner. So we have
identified the handful of worst calculable `xbrl_factoid` offenders
`self.off_by_facts`. This method identifies data corrections for those
`self.off_by_facts` and adds them into the exploded data table.
...
with [`numpy.isclose()`](https://numpy.org/doc/stable/reference/generated/numpy.isclose.html#numpy.isclose) using an absolute tolerance of $5. `np.isclose`’s
...
Relatedly, [`add_sizable_minority_corrections_to_calcs()`](#pudl.output.ferc1.Exploder.add_sizable_minority_corrections_to_calcs) adds these
`self.off_by_facts` to `self.exploded_calcs`.

#### reconcile_intertable_calculations(exploded: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
### *class* pudl.output.ferc1.XbrlCalculationForestFerc1(/, \*\*data: Any)
...
[`Exploder.exploded_calcs()`](#pudl.output.ferc1.Exploder.exploded_calcs). Seed nodes can be used to indicate which nodes
...
#### *classmethod* tags_have_required_cols(v: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), info: [pydantic.ValidationInfo](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Ensure tagging dataframe contains all required index columns.

#### *classmethod* tags_cols_notnull(v: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Ensure all tags have non-null table_name and xbrl_factoid.

#### *classmethod* single_valued_tags(v: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), info: [pydantic.ValidationInfo](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[`propagate_node_attributes()`](#pudl.output.ferc1.XbrlCalculationForestFerc1.propagate_node_attributes) so we can check conflicts within the tags
...
Prune the full digraph to contain only those nodes in the [`full_digraph()`](#pudl.output.ferc1.XbrlCalculationForestFerc1.full_digraph)
...
We compile a list of all the [`NodeId`](#pudl.output.ferc1.NodeId) values that should be included in
...
[`seeded_digraph()`](#pudl.output.ferc1.XbrlCalculationForestFerc1.seeded_digraph) into a collection of trees. The main issue we currently
...
#### *property* leafy_meta *: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)*
...
#### *property* root_calculations *: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)*
...
#### *property* forest_as_table *: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)*
...
#### \_add_layers_to_forest_as_table(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
* **Parameters:**
  ...
  * **nodes** – List of [`NodeId`](#pudl.output.ferc1.NodeId) values to extract from the calculation forest.
* **Returns:**
...
* **Parameters:**
  * **df** – table to check. This should be either the
    [`out_ferc1__yearly_rate_base()`](#pudl.output.ferc1.out_ferc1__yearly_rate_base), `exploded_balance_sheet_assets_ferc1`
  ...
  * **\_out_ferc1_\_explosion_tags** – manually compiled tags. This table includes tags from
...
### pudl.output.ferc1.out_ferc1_\_yearly_rate_base(out_ferc1_\_yearly_detailed_balance_sheet_assets: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), out_ferc1_\_yearly_detailed_balance_sheet_liabilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_ferc1_\_yearly_operating_expenses_sched320: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame), core_pudl_\_assn_ferc1_pudl_utilities: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
[`disaggregate_null_or_total_tag()`](#pudl.output.ferc1.disaggregate_null_or_total_tag).

### pudl.output.ferc1.replace_dimension_columns_with_aggregatable(df: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)

Replace the dimension columns with their aggregatable counterparts.

### *class* pudl.output.ferc1.Ferc1DetailedCheckSpec
...
### pudl.output.ferc1.prep_cash_working_capital(core_ferc1_\_yearly_operating_expenses_sched320) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
* `get_tag_col_ratio()` : for each `report_year` and `utility_id_ferc1`,
...
In practice, this was built to be used within [`disaggregate_null_or_total_tag()`](#pudl.output.ferc1.disaggregate_null_or_total_tag).
