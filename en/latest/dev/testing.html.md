...
We use [pytest](https://pytest.org) to specify software unit, integration, and
pipeline tests, including calling `dbt build` to run our
[Data validation quickstart](data_validation_quickstart.html.md) tests. Several common test commands are available as
...
Zenodo](https://zenodo.org/communities/catalyst-cooperative). A copy of that data
