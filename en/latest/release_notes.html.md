...
started publishing a [DuckDB](https://duckdb.org) version of the PUDL database! We
...
* Added NREL ATB 2025 data. See PR [#5569](https://github.com/catalyst-cooperative/pudl/pull/5569).
...
* Calibrated per-year error thresholds for the heat-rate outlier checks on
  [out_epacems_\_yearly_operational_characteristics](data_dictionaries/pudl_db.html.md#out-epacems-yearly-operational-characteristics), since the multi-year
  extension in PR [#5474](https://github.com/catalyst-cooperative/pudl/pull/5474) introduced report years whose data quality, and thus
  expected outlier rate, varies considerably over the 2000-2025 span. See PR
  [#5571](https://github.com/catalyst-cooperative/pudl/pull/5571).
...
* Fixed `set_gcs_temporary_hold` only protecting the top level of a versioned
  ...
  bug. See PR [#5477](https://github.com/catalyst-cooperative/pudl/pull/5477).
...
* Fixed several sources of non-deterministic row counts, where identical code and data
  ...
  the instability. See [#4574](https://github.com/catalyst-cooperative/pudl/issues/4574), [#4254](https://github.com/catalyst-cooperative/pudl/issues/4254), and [#5503](https://github.com/catalyst-cooperative/pudl/pull/5503).
...
* Improved the robustness of [FERC EQR](data_sources/ferceqr.html.md) raw data extraction.
  ...
  values, matching the behavior of other PUDL categorical columns. See PR [#5442](https://github.com/catalyst-cooperative/pudl/pull/5442).
* Disabled primary key uniqueness enforcement on
  [core_ferceqr_\_quarterly_index_pub](data_dictionaries/pudl_db.html.md#core-ferceqr-quarterly-index-pub), which was found to contain duplicate primary
  key values in FERC EQR filings from 2023 onward. See PR [#5442](https://github.com/catalyst-cooperative/pudl/pull/5442).
...
* Closed a long-standing gap in which Pandera’s Polars backend only checked column
  ...
  mechanisms, so no data quality issues resulted from this gap. See PR [#5432](https://github.com/catalyst-cooperative/pudl/pull/5432).
* Corrected the `last_annual_meeting_date` field in
  [core_rus7_\_yearly_meeting_and_board](data_dictionaries/pudl_db.html.md#core-rus7-yearly-meeting-and-board) and
  [core_rus12_\_yearly_meeting_and_board](data_dictionaries/pudl_db.html.md#core-rus12-yearly-meeting-and-board) from a `datetime` to a `date` type.
  See PR [#5518](https://github.com/catalyst-cooperative/pudl/pull/5518).
...
* Reworked how the Google Batch jobs launched by the `build-pudl`,
  ...
  `batch_config` script ([`pudl.scripts.batch_config`](autoapi/pudl/scripts/batch_config/index.html.md#module-pudl.scripts.batch_config)); the workflows now
...
* Validate foreign key constraints with dbt instead of SQLite. Update our
  ...
  See issues [#4564](https://github.com/catalyst-cooperative/pudl/issues/4564), [#5208](https://github.com/catalyst-cooperative/pudl/issues/5208) and PR [#5519](https://github.com/catalyst-cooperative/pudl/pull/5519).
