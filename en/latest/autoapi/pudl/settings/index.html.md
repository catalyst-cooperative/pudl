...
#### *property* partitions *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[None](https://docs.python.org/3/builtins/constants.html#None) | [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [str](https://docs.python.org/3/builtins/stdtypes.html#str)]]*
...
#### year_quarters *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]*
...
#### *property* extraction_years *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[int](https://docs.python.org/3/builtins/functions.html#int)]*
...
#### half_years *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]*
...
#### eia860m *: [bool](https://docs.python.org/3/builtins/functions.html#bool)* *= True*

Whether or not to incorporate an EIA-860m month.

#### all_eia860m_year_months *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]*
...
#### *classmethod* add_other_860m_years(v, info: [pydantic.ValidationInfo](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)) → [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]
...
#### *classmethod* no_repeat_years(v, info: [pydantic.ValidationInfo](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)) → [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]

Make sure there are no duplicate 860m year values.

#### *classmethod* validate_eia860m_params(v, info: [pydantic.ValidationInfo](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)) → [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]

Check that the year_month values for eia860m_year_months are valid.

#### *classmethod* only_years_not_in_eia860(v, info: [pydantic.ValidationInfo](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)) → [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]
...
#### year_months *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]*
...
#### fips *: [bool](https://docs.python.org/3/builtins/functions.html#bool)* *= True*
...
#### eia *: [bool](https://docs.python.org/3/builtins/functions.html#bool)* *= True*

Include eia in glue data configuration.

#### ferc1 *: [bool](https://docs.python.org/3/builtins/functions.html#bool)* *= True*
...
#### technology_types *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]* *= ['wind', 'solar']*

#### processing_levels *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]* *= ['extended']*

#### daily_weather *: [bool](https://docs.python.org/3/builtins/functions.html#bool)* *= True*

#### *classmethod* deduplicate_list(v)

Deduplicate technology type and processing level values.

#### *classmethod* allowed_technology_types(v: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]) → [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]

Ensure that technology types are valid.

#### *classmethod* allowed_processing_levels(v: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]) → [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]

Ensure that processing levels are valid.

#### *property* parts *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]*
...
#### eia176 *: [Eia176DataConfig](#pudl.settings.Eia176DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eia191 *: [Eia191DataConfig](#pudl.settings.Eia191DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eia757a *: [Eia757aDataConfig](#pudl.settings.Eia757aDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eia860 *: [Eia860DataConfig](#pudl.settings.Eia860DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eia860m *: [Eia860mDataConfig](#pudl.settings.Eia860mDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eia861 *: [Eia861DataConfig](#pudl.settings.Eia861DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eia923 *: [Eia923DataConfig](#pudl.settings.Eia923DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eia930 *: [Eia930DataConfig](#pudl.settings.Eia930DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### eiaaeo *: [EiaAeoDataConfig](#pudl.settings.EiaAeoDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### *classmethod* default_load_all(data: [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]) → [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]

If no datasets are specified default to all.

#### *classmethod* check_eia_dependencies(data: [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]) → [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]
...
* **Parameters:**
  **values** (*Dict* *[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str) *,* *BaseModel* *]*) – dataset data configuration.
* **Returns:**
  dataset data configuration.
* **Return type:**
  values (Dict[[str](https://docs.python.org/3/builtins/stdtypes.html#str), BaseModel])
...
#### eia *: [EiaDataConfig](#pudl.settings.EiaDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### epacems *: [EpaCemsDataConfig](#pudl.settings.EpaCemsDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### epamats *: [EpaMatsDataConfig](#pudl.settings.EpaMatsDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc1 *: [Ferc1DataConfig](#pudl.settings.Ferc1DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc714 *: [Ferc714DataConfig](#pudl.settings.Ferc714DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### glue *: [GlueDataConfig](#pudl.settings.GlueDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### gridpathratoolkit *: [GridPathRaToolkitDataConfig](#pudl.settings.GridPathRaToolkitDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### nrelatb *: [NrelAtbDataConfig](#pudl.settings.NrelAtbDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### phmsagas *: [PhmsaGasDataConfig](#pudl.settings.PhmsaGasDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### sec10k *: [Sec10kDataConfig](#pudl.settings.Sec10kDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### vcerare *: [VceRareDataConfig](#pudl.settings.VceRareDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### censuspep *: [CensusPepDataConfig](#pudl.settings.CensusPepDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### rus7 *: [Rus7DataConfig](#pudl.settings.Rus7DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### rus12 *: [Rus12DataConfig](#pudl.settings.Rus12DataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*
...
#### *classmethod* add_glue_data_config(data: [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]) → [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]

Add glue data configuration if ferc1 and eia data are both requested.

* **Parameters:**
  **values** (*Dict* *[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str) *,* *BaseModel* *]*) – PUDL data configuration.
* **Returns:**
...
#### refyear *: ClassVar[[int](https://docs.python.org/3/builtins/functions.html#int)]*
...
### *class* pudl.settings.FercGenericXbrlToSqliteDataConfig(\_case_sensitive: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_nested_model_default_partial_update: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_prefix: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_prefix_target: pydantic_settings.sources.EnvPrefixTarget | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_file: pydantic_settings.sources.DotenvType | [None](https://docs.python.org/3/builtins/constants.html#None) = ENV_FILE_SENTINEL, \_env_file_encoding: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_ignore_empty: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_nested_delimiter: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_nested_max_split: [int](https://docs.python.org/3/builtins/functions.html#int) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_parse_none_str: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_env_parse_enums: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_prog_name: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_parse_args: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)] | [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), ...] | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_settings_source: [pydantic_settings.sources.CliSettingsSource](https://pydantic.dev/docs/validation/latest/api/pydantic_settings/#pydantic_settings.CliSettingsSource)[Any] | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_parse_none_str: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_hide_none_type: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_avoid_json: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_enforce_required: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_use_class_docs_for_groups: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_show_env_vars: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_exit_on_error: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_prefix: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_flag_prefix_char: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_implicit_flags: [bool](https://docs.python.org/3/builtins/functions.html#bool) | Literal['dual', 'toggle'] | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_ignore_unknown_args: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_kebab_case: [bool](https://docs.python.org/3/builtins/functions.html#bool) | Literal['all', 'no_enums'] | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_cli_shortcuts: [collections.abc.Mapping](https://docs.python.org/3/library/collections.abc.html#collections.abc.Mapping)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]] | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_secrets_dir: pydantic_settings.sources.PathType | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \_build_sources: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[pydantic_settings.sources.PydanticBaseSettingsSource](https://pydantic.dev/docs/validation/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource), ...], [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]] | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \*\*values: Any)
...
#### ferc1_dbf *: [Ferc1DbfToSqliteDataConfig](#pudl.settings.Ferc1DbfToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc1_xbrl *: [Ferc1XbrlToSqliteDataConfig](#pudl.settings.Ferc1XbrlToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc2_dbf *: [Ferc2DbfToSqliteDataConfig](#pudl.settings.Ferc2DbfToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc2_xbrl *: [Ferc2XbrlToSqliteDataConfig](#pudl.settings.Ferc2XbrlToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc6_dbf *: [Ferc6DbfToSqliteDataConfig](#pudl.settings.Ferc6DbfToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc6_xbrl *: [Ferc6XbrlToSqliteDataConfig](#pudl.settings.Ferc6XbrlToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc60_dbf *: [Ferc60DbfToSqliteDataConfig](#pudl.settings.Ferc60DbfToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc60_xbrl *: [Ferc60XbrlToSqliteDataConfig](#pudl.settings.Ferc60XbrlToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### ferc714_xbrl *: [Ferc714XbrlToSqliteDataConfig](#pudl.settings.Ferc714XbrlToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### *classmethod* default_load_all(data: [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]) → [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]

If no datasets are specified default to all.

#### get_data_config(dataset: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [FercForm](#pudl.settings.FercForm), data_format: Literal['dbf', 'xbrl']) → [FercGenericXbrlToSqliteDataConfig](#pudl.settings.FercGenericXbrlToSqliteDataConfig) | [FercDbfToSqliteDataConfig](#pudl.settings.FercDbfToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)
...
#### get_dataset_years(dataset: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [FercForm](#pudl.settings.FercForm), data_format: Literal['dbf', 'xbrl']) → [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[int](https://docs.python.org/3/builtins/functions.html#int)]

Look up extraction *years* by dataset (`fercX`) and data format (`dbf` or `xbrl`).

* **Raises:**
  [**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) – if the dataset/format combination is not configured.
...
#### ferc_to_sqlite *: [FercToSqliteDataConfig](#pudl.settings.FercToSqliteDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

#### pudl *: [PudlDataConfig](#pudl.settings.PudlDataConfig) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*
...
#### *classmethod* from_yaml(path: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [pathlib.Path](https://docs.python.org/3/library/pathlib.html#pathlib.Path)) → [GlobalDataConfig](#pudl.settings.GlobalDataConfig)
