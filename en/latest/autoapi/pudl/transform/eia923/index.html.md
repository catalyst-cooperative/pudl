...
### pudl.transform.eia923.\_core_eia923_\_yearly_fuel_stocks(raw_eia923_\_stocks: [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)) → [pandas.DataFrame](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.html#pandas.DataFrame)
...
* reshapes the wide monthly stock columns into tall monthly records via
  [`_yearly_to_monthly_records()`](#pudl.transform.eia923._yearly_to_monthly_records), keeping one column per fuel type,
...
[issue #5081](https://github.com/catalyst-cooperative/pudl/issues/5081)).

* **Parameters:**
  **raw_eia923_\_stocks** – The raw `raw_eia923__stocks` dataframe.
* **Returns:**
