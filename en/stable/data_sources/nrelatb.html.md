...
| Source URL                      | [https://atb.nrel.gov/](https://atb.nrel.gov/)                                                                                                                                                                    |
|---------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
See issue [#3576](https://github.com/catalyst-cooperative/pudl/issues/3576) for why we have not integrated the 2019 and 2020 parquet files.
...
[ATB site](https://atb.nrel.gov). You can also access all of the formats on our
[Zenodo archive of raw NREL ATB data](https://zenodo.org/records/15772175).
...
NREL also publishes extensive [documentation](https://atb.nrel.gov/electricity/2024/about).
