...
* Consolidated local and remote Zenodo cache management under a single API that uses the
  high-level abstraction of the :class:`upath.UPath` class. This is a further
  refinement and simplification that became obvious after the above refactoring. See
  issue :issue:`4860` and PR :pr:`4870`.
