...
* Added a :doc:`methodology page </methodology/entity_harvesting>` explaining
  ...
  tables. The docs now also support Mermaid flowcharts for illustrating
  pipeline behavior. See :pr:`5071`.
