...
-------------------- ----------------------------------------------------------
``dagster_home/``    logs and outputs created by dagsster instance.
==================== ==========================================================

To let dagster know where the ``dagster_home`` directory is, set the
``DAGSTER_HOME`` environment variable to the path of the ``dagster_home/`` directory:

.. code-block:: console

    $ mamba env config vars set DAGSTER_HOME=<PUDL_DIR>/dagster_home
